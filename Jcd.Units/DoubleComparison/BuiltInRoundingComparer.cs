...
public readonly struct BuiltInRoundingComparer : IValueComparer<double>
{
   ...
   /// <summary>
   /// Constructs an instance of <see cref="BuiltInRoundingComparer" /> from number of decimal places and a rounding
   /// method.
   /// </summary>
   ...
   {
      return Math.Round(value, DecimalPlaces, RoundingMethod);
   }
