...
public static class MathQ
{
   ...
   /// <summary>
   /// Returns the smallest integral value greater than or equal to the numeric component of the <see cref="Quantity{TUnit}" />.
   /// </summary>
   /// <param name="quantity">The quantity</param>
   /// <typeparam name="TUnit">The type of unit of measure. (e.g. temperature)</typeparam>
   ...
   public static Quantity<TUnit> Round<TUnit>
            ...
            where TUnit : UnitOfMeasure<TUnit>
      => Math.Round(quantity.RawValue, digits, mode)
             .As(quantity.Unit);
   ...
   public static Quantity<Angle> Acos(double value, Angle? outputUnitOfMeasure = null)
   {
      ...
      return outputUnitOfMeasure is null ? degreesRadians : degreesRadians.To(outputUnitOfMeasure);
   }
