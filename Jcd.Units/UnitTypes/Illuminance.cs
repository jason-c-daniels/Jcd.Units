...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Illuminance" /> using another <see cref="Illuminance" /> as a
   /// reference.
   /// </summary>
   ...
   public Illuminance(
      string name, string symbol, Illuminance? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
