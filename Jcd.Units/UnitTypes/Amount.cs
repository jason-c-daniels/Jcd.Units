...
/// </summary>
public record Amount : UnitOfMeasure<Amount>
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Amount" /> using another <see cref="Amount" /> as a reference.
   /// </summary>
   ...
   public Amount(
      string name, string symbol, Amount? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null, string system = ""
   )
