...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="ElectricalPotential" /> using another
   /// <see cref="ElectricalPotential" /> as a reference.
   /// </summary>
   ...
   public ElectricalPotential(
      string name, string symbol, ElectricalPotential? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
