...
public record struct ElectricalPotential(string Name, string Symbol, double Coefficient=1, double Offset=0)
    : IUnitOfMeasure<ElectricalPotential>
{
    ...
    /// <returns>-1 if less than; 1 if greater than; 0 if equals.</returns>
    /// <exception cref="ArgumentException">When the passed in object is not a <c>ElectricalPotential</c></exception>
