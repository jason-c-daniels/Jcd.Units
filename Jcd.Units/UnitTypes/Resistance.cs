...
/// </summary>
public record Resistance : UnitOfMeasure<Resistance>
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Resistance" /> using another <see cref="Resistance" /> as a
   /// reference.
   /// </summary>
   ...
   public Resistance(
      string name, string symbol, Resistance? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
