...
/// </summary>
public record Inductance : UnitOfMeasure<Inductance>
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Inductance" /> using another <see cref="Inductance" /> as a
   /// reference.
   /// </summary>
   ...
   public Inductance(
      string name, string symbol, Inductance? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
