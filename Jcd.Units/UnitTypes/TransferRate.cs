...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="TransferRate" /> using another <see cref="TransferRate" /> as a
   /// reference.
   /// </summary>
   ...
   public TransferRate(
      string name, string symbol, TransferRate? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
