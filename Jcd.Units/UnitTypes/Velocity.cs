...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Velocity" /> using another <see cref="Velocity" /> as a
   /// reference.
   /// </summary>
   ...
   public Velocity(
      string name, string symbol, Velocity? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null, string system = ""
   )
