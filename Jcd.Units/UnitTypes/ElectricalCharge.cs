...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="ElectricalCharge" /> using another
   /// <see cref="ElectricalCharge" /> as a reference.
   /// </summary>
   ...
   public ElectricalCharge(
      string name, string symbol, ElectricalCharge? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
