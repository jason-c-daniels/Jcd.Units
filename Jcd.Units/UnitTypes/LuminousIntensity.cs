...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="LuminousIntensity" /> using another
   /// <see cref="LuminousIntensity" /> as a reference.
   /// </summary>
   ...
   public LuminousIntensity(
      string name, string symbol, LuminousIntensity? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
