...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Acceleration" /> using another <see cref="Acceleration" /> as a
   /// reference.
   /// </summary>
   ...
   public Acceleration(
      string name, string symbol, Acceleration? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
