...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="LuminousFlux" /> using another <see cref="LuminousFlux" /> as a
   /// reference.
   /// </summary>
   ...
   public LuminousFlux(
      string name, string symbol, LuminousFlux? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
