...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="RadioactiveDecay" /> using another
   /// <see cref="RadioactiveDecay" /> as a reference.
   /// </summary>
   ...
   public RadioactiveDecay(
      string name, string symbol, RadioactiveDecay? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
