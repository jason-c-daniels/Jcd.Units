...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="CatalyticActivity" /> using another
   /// <see cref="CatalyticActivity" /> as a reference.
   /// </summary>
   ...
   public CatalyticActivity(
      string name, string symbol, CatalyticActivity? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
