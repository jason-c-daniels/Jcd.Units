...
public record Duration(string Name, string Symbol, double Coefficient=1, double Offset=0) 
    : UnitOfMeasure<Duration>(Name,Symbol,Coefficient,Offset)
{
    /// <summary>
    /// Constructs a unit measuring a specified <see cref="Duration" /> using another <see cref="Duration" /> as a reference.
    /// </summary>
