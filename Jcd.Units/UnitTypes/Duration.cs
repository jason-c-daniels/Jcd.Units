...
/// </summary>
public record Duration : UnitOfMeasure<Duration>
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Duration" /> using another <see cref="Duration" /> as a
   /// reference.
   /// </summary>
   ...
   public Duration(
      string name, string symbol, Duration? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null, string system = ""
   )
