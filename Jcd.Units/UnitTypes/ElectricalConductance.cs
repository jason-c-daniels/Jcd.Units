...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="ElectricalConductance" /> using another
   /// <see cref="ElectricalConductance" /> as a reference.
   /// </summary>
   ...
   public ElectricalConductance(
      string name, string symbol, ElectricalConductance? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
