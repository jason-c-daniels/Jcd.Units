...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Pressure" /> using another <see cref="Pressure" /> as a
   /// reference.
   /// </summary>
   ...
   public Pressure(
      string name, string symbol, Pressure? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null, string system = ""
   )
