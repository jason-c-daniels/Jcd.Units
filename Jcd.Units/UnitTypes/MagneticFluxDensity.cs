...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="MagneticFluxDensity" /> using another
   /// <see cref="MagneticFluxDensity" /> as a reference.
   /// </summary>
   ...
   public MagneticFluxDensity(
      string name, string symbol, MagneticFluxDensity? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
