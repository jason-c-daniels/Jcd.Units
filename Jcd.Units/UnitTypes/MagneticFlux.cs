...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="MagneticFlux" /> using another <see cref="MagneticFlux" /> as a
   /// reference.
   /// </summary>
   ...
   public MagneticFlux(
      string name, string symbol, MagneticFlux? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
