...
public record struct RadiationEquivalentDose(string Name, string Symbol, double Coefficient=1, double Offset=0)
    : IUnitOfMeasure<RadiationEquivalentDose>
{
    ...
    /// <returns>-1 if less than; 1 if greater than; 0 if equals.</returns>
    /// <exception cref="ArgumentException">When the passed in object is not a <c>RadiationEquivalentDose</c></exception>
