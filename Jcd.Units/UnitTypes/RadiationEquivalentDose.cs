...
/// radiation.
/// </summary>
public record RadiationEquivalentDose : UnitOfMeasure<RadiationEquivalentDose>
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="RadiationEquivalentDose" /> using another
   /// <see cref="RadiationEquivalentDose" /> as a reference.
   /// </summary>
   ...
   public RadiationEquivalentDose(
      string name, string symbol, RadiationEquivalentDose? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
