...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="ElectricalCurrent" /> using another <see cref="ElectricalCurrent" /> as a reference.
   /// </summary>
   ...
   public ElectricalCurrent
            (string name, string symbol, ElectricalCurrent baseUnit, double coefficient, double offset = 0)
