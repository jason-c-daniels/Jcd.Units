...
{
   /// <summary>
   /// Constructs a unit measuring a specified <see cref="Temperature" /> using another <see cref="Temperature" /> as a
   /// reference.
   /// </summary>
   ...
   public Temperature(
      string name, string symbol, Temperature? baseUnit = null, double coefficient = 1.0, double offset = 0, IValueComparer<double>? comparer = null
    , string system = ""
   )
