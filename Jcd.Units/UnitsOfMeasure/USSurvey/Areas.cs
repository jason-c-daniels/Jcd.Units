...
public class Areas : UnitOfMeasureEnumeration<Areas, Area>
{
   ...
   /// <summary>
   /// A(n) square league. Defined as: ((4828.032)*(4828.032)) × SI square meter + (0).
   /// </summary>
