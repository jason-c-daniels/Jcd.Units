...
{
   /// <summary>
   /// A(n) light-year. Defined as: (9_460_730_472_580_800.0) × SI meter + (0).
   /// </summary>
   public static readonly Length LightYear = new ("light-year", "ly", SI.Lengths.Meter, 9_460_730_472_580_800.0, 0);

   /// <summary>
   /// A(n) dekalight-year. Defined as: (10.0) × light-year + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) kilolight-year. Defined as: (10.0) × hectolight-year + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) zettalight-year. Defined as: (1000.0) × exalight-year + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) light-second. Defined as: (299_792_458.0) × SI meter + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) astronomical unit. Defined as: (149597870.691) × SI kilometer + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) light-day. Defined as: (24.0) × light-hour + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) dekaparsec. Defined as: (10.0) × parsec + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) kiloparsec. Defined as: (10.0) × hectoparsec + (0).
   /// </summary>
   public static readonly Length Kiloparsec = new ("kiloparsec", "kpc", Hectoparsec, 10.0, 0);

   /// <summary>
   /// A(n) megaparsec. Defined as: (1000.0) × kiloparsec + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) petaparsec. Defined as: (1000.0) × teraparsec + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) ronnaparsec. Defined as: (1000.0) × yottaparsec + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) jovian radius. Defined as: (69_911.0) × SI kilometer + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) earth circumference. Defined as: (Math.PI) × earth diameter + (0).
   /// </summary>
