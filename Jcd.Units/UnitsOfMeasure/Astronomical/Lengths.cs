...
public class Lengths : Enumeration<Lengths,Length>
{
    ...
    /// <summary>
    /// A(n) microlight-year. It's defined in terms of a(n) millilight-year.
    /// </summary>
    public static readonly Length MicrolightYear = new ("microlight-year", "μly", MillilightYear, 1.0/1000.0,0);
    
    /// <summary>
    /// A(n) nanolight-year. It's defined in terms of a(n) microlight-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) attolight-year. It's defined in terms of a(n) femtolight-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) yoctolight-year. It's defined in terms of a(n) zeptolight-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) hectolight-year. It's defined in terms of a(n) dekalight-year.
    /// </summary>
    public static readonly Length HectolightYear = new ("hectolight-year", "hly", DekalightYear, 10,0);
    
    /// <summary>
    /// A(n) kilolight-year. It's defined in terms of a(n) hectolight-year.
    /// </summary>
    public static readonly Length KilolightYear = new ("kilolight-year", "kly", HectolightYear, 10,0);
    
    /// <summary>
    /// A(n) megalight-year. It's defined in terms of a(n) kilolight-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) quettalight-year. It's defined in terms of a(n) ronnalight-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) light-minute. It's defined in terms of a(n) light-second.
    /// </summary>
    ...
    /// <summary>
    /// A(n) light-hour. It's defined in terms of a(n) light-minute.
    /// </summary>
    ...
    /// <summary>
    /// A(n) light-week. It's defined in terms of a(n) light-day.
    /// </summary>
    public static readonly Length LightWeek = new ("light-week", "lw", LightDay, 7,0);
    
    /// <summary>
    /// A(n) parsec. It's defined in terms of a(n) light-year.
    /// </summary>
    ...
    /// <summary>
    /// A(n) milliparsec. It's defined in terms of a(n) centiparsec.
    /// </summary>
    ...
    /// <summary>
    /// A(n) picoparsec. It's defined in terms of a(n) nanoparsec.
    /// </summary>
    ...
    /// <summary>
    /// A(n) attoparsec. It's defined in terms of a(n) femtoparsec.
    /// </summary>
    ...
    /// <summary>
    /// A(n) dekaparsec. It's defined in terms of a(n) parsec.
    /// </summary>
