...
public class Volumes : UnitOfMeasureEnumeration<Volumes, Volume>
{
   ...
   /// <summary>
   /// A(n) cubic mil. Defined as: ((1.0/1000.0)*(1.0/1000.0)*(1.0/1000.0)) × cubic inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) cubic point. Defined as: ((1.0/72.0)*(1.0/72.0)*(1.0/72.0)) × cubic inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) cubic twip. Defined as: ((1.0/20.0)*(1.0/20.0)*(1.0/20.0)) × cubic point + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) cubic foot. Defined as: ((12.0)*(12.0)*(12.0)) × cubic inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) cubic mile. Defined as: ((1760.0)*(1760.0)*(1760.0)) × cubic yard + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) cubic fathom. Defined as: ((2.0)*(2.0)*(2.0)) × cubic yard + (0).
   /// </summary>
   public static readonly Volume CubicFathom = new ("cubic fathom", "ftm³", CubicYard, 2.0 * 2.0 * 2.0, 0);

   /// <summary>
   /// A(n) cubic cable. Defined as: ((120.0)*(120.0)*(120.0)) × cubic fathom + (0).
   /// </summary>
   public static readonly Volume CubicCable = new ("cubic cable", "cb³", CubicFathom, 120.0 * 120.0 * 120.0, 0);

   /// <summary>
   /// A(n) cubic nautical mile. Defined as: ((1852.0)*(1852.0)*(1852.0)) × SI cubic meter + (0).
   /// </summary>
