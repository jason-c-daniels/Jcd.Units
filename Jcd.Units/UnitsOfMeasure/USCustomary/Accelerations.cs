...
{
   /// <summary>
   /// nautical mile per square octillion years defined such that: SI meter per square septillion years = nmi/Ryr² ×
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareOctillionYears = new("nautical mile per square octillion years"
                                                                               , "nmi/Ryr²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareTrillionYears = new("nautical mile per square trillion years"
                                                                              , "nmi/Tyr²"
   ...
   /// (1852.0)/((10.0)*(10.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareDecade = new("nautical mile per square decade"
                                                                       , "nmi/decade²"
   ...
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareMinute = new("nautical mile per square minute"
                                                                       , "nmi/min²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareQuintillionYears = new("nautical mile per square quintillion years"
                                                                                 , "nmi/Eyr²"
   ...
   /// (1852.0)/((10.0)*(10.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareMillennium = new("nautical mile per square millennium"
                                                                           , "nmi/kyr²"
   ...
   /// (1852.0)/((100.0)*(100.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareTick = new("nautical mile per square tick"
                                                                     , "nmi/tick²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareSeptillionYears = new("nautical mile per square septillion years"
                                                                                , "nmi/Yyr²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareBillionYears = new("nautical mile per square billion years"
                                                                             , "nmi/Gyr²"
   ...
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareYear = new("nautical mile per square year"
                                                                     , "nmi/yr²"
   ...
   /// </summary>
   public static readonly Acceleration InchPerSquareMinute = new("inch per square minute"
                                                               , "in/min²"
                                                               , SI.Accelerations.CentimeterPerSquareSecond
                                                               , 2.54 / (60.0 * 60.0)
                                                               , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration MilPerSquarePlanckTime = new("mil per square planck-time"
                                                                  , "mil/tₚ²"
   ...
   /// </summary>
   public static readonly Acceleration MilPerSquareDecisecond = new("mil per square decisecond"
                                                                  , "mil/ds²"
                                                                  , InchPerSquareSecond
                                                                  , 1.0 / 1000.0 / (1.0 / 10.0 * (1.0 / 10.0))
                                                                  , system: "US Customary"
   ...
   /// (1.0/1000.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareCentisecond = new("mil per square centisecond"
                                                                   , "mil/cs²"
   ...
   /// (1.0/1000.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareMillisecond = new("mil per square millisecond"
                                                                   , "mil/ms²"
   ...
   /// </summary>
   public static readonly Acceleration MilPerSquareMicrosecond = new("mil per square microsecond"
                                                                   , "mil/μs²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareNanosecond = new("mil per square nanosecond"
                                                                  , "mil/ns²"
                                                                  , InchPerSquareMicrosecond
                                                                  , 1.0 / 1000.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                  , system: "US Customary"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquarePicosecond = new("mil per square picosecond"
                                                                  , "mil/ps²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareFemtosecond = new("mil per square femtosecond"
                                                                   , "mil/fs²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareAttosecond = new("mil per square attosecond"
                                                                  , "mil/as²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareZeptosecond = new("mil per square zeptosecond"
                                                                   , "mil/zs²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareYoctosecond = new("mil per square yoctosecond"
                                                                   , "mil/ys²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareRontosecond = new("mil per square rontosecond"
                                                                   , "mil/rs²"
   ...
   /// (1.0/1000.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareQuectosecond = new("mil per square quectosecond"
                                                                    , "mil/qs²"
   ...
   /// </summary>
   public static readonly Acceleration PointPerSquarePlanckTime = new("point per square planck-time"
                                                                    , "p/tₚ²"
                                                                    , InchPerSquareMicrosecond
                                                                    , 1.0 / 72.0 / (5.391247E-38 * 5.391247E-38)
                                                                    , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration PointPerSquareCentisecond = new("point per square centisecond"
                                                                     , "p/cs²"
                                                                     , InchPerSquareDecisecond
                                                                     , 1.0 / 72.0 / (1.0 / 10.0 * (1.0 / 10.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareMillisecond = new("point per square millisecond"
                                                                     , "p/ms²"
                                                                     , InchPerSquareCentisecond
                                                                     , 1.0 / 72.0 / (1.0 / 10.0 * (1.0 / 10.0))
                                                                     , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration PointPerSquareMicrosecond = new("point per square microsecond"
                                                                     , "p/μs²"
                                                                     , InchPerSquareMillisecond
                                                                     , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareNanosecond = new("point per square nanosecond"
                                                                    , "p/ns²"
                                                                    , InchPerSquareMicrosecond
                                                                    , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquarePicosecond = new("point per square picosecond"
                                                                    , "p/ps²"
                                                                    , InchPerSquareNanosecond
                                                                    , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareFemtosecond = new("point per square femtosecond"
                                                                     , "p/fs²"
                                                                     , InchPerSquarePicosecond
                                                                     , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareAttosecond = new("point per square attosecond"
                                                                    , "p/as²"
                                                                    , InchPerSquareFemtosecond
                                                                    , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareZeptosecond = new("point per square zeptosecond"
                                                                     , "p/zs²"
                                                                     , InchPerSquareAttosecond
                                                                     , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareYoctosecond = new("point per square yoctosecond"
                                                                     , "p/ys²"
                                                                     , InchPerSquareZeptosecond
                                                                     , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareRontosecond = new("point per square rontosecond"
                                                                     , "p/rs²"
                                                                     , InchPerSquareYoctosecond
                                                                     , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (1.0/72.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareQuectosecond = new("point per square quectosecond"
                                                                      , "p/qs²"
                                                                      , InchPerSquareRontosecond
                                                                      , 1.0 / 72.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration TwipPerSquareDecisecond = new("twip per square decisecond"
                                                                   , "twip/ds²"
   ...
   /// </summary>
   public static readonly Acceleration PicaPerSquarePlanckTime = new("pica per square planck-time"
                                                                   , "P/tₚ²"
                                                                   , PointPerSquareMicrosecond
                                                                   , 12.0 / (5.391247E-38 * 5.391247E-38)
                                                                   , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration PicaPerSquareMicrosecond = new("pica per square microsecond"
                                                                    , "P/μs²"
                                                                    , PointPerSquareMillisecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareNanosecond = new("pica per square nanosecond"
                                                                   , "P/ns²"
                                                                   , PointPerSquareMicrosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquarePicosecond = new("pica per square picosecond"
                                                                   , "P/ps²"
                                                                   , PointPerSquareNanosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareFemtosecond = new("pica per square femtosecond"
                                                                    , "P/fs²"
                                                                    , PointPerSquarePicosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareAttosecond = new("pica per square attosecond"
                                                                   , "P/as²"
                                                                   , PointPerSquareFemtosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareZeptosecond = new("pica per square zeptosecond"
                                                                    , "P/zs²"
                                                                    , PointPerSquareAttosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareYoctosecond = new("pica per square yoctosecond"
                                                                    , "P/ys²"
                                                                    , PointPerSquareZeptosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareRontosecond = new("pica per square rontosecond"
                                                                    , "P/rs²"
                                                                    , PointPerSquareYoctosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareQuectosecond = new("pica per square quectosecond"
                                                                     , "P/qs²"
                                                                     , PointPerSquareRontosecond
                                                                     , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration InchPerSquareYear = new("inch per square year"
                                                             , "in/yr²"
   ...
   /// (12.0)/((5.391247E-38)*(5.391247E-38)).
   /// </summary>
   public static readonly Acceleration FootPerSquarePlanckTime = new("foot per square planck-time"
                                                                   , "ft/tₚ²"
                                                                   , InchPerSquareMicrosecond
                                                                   , 12.0 / (5.391247E-38 * 5.391247E-38)
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareMicrosecond = new("foot per square microsecond"
                                                                    , "ft/μs²"
                                                                    , InchPerSquareMillisecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareNanosecond = new("foot per square nanosecond"
                                                                   , "ft/ns²"
                                                                   , InchPerSquareMicrosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquarePicosecond = new("foot per square picosecond"
                                                                   , "ft/ps²"
                                                                   , InchPerSquareNanosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareFemtosecond = new("foot per square femtosecond"
                                                                    , "ft/fs²"
                                                                    , InchPerSquarePicosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareAttosecond = new("foot per square attosecond"
                                                                   , "ft/as²"
                                                                   , InchPerSquareFemtosecond
                                                                   , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareZeptosecond = new("foot per square zeptosecond"
                                                                    , "ft/zs²"
                                                                    , InchPerSquareAttosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareYoctosecond = new("foot per square yoctosecond"
                                                                    , "ft/ys²"
                                                                    , InchPerSquareZeptosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareRontosecond = new("foot per square rontosecond"
                                                                    , "ft/rs²"
                                                                    , InchPerSquareYoctosecond
                                                                    , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                    , system: "US Customary"
   ...
   /// (12.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareQuectosecond = new("foot per square quectosecond"
                                                                     , "ft/qs²"
                                                                     , InchPerSquareRontosecond
                                                                     , 12.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration InchPerSquareDecade = new("inch per square decade"
                                                               , "in/decade²"
   ...
   /// </summary>
   public static readonly Acceleration YardPerSquareMicrosecond = new("yard per square microsecond"
                                                                    , "yd/μs²"
   ...
   /// (3.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareNanosecond = new("yard per square nanosecond"
                                                                   , "yd/ns²"
   ...
   /// (3.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareAttosecond = new("yard per square attosecond"
                                                                   , "yd/as²"
   ...
   /// (3.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareYoctosecond = new("yard per square yoctosecond"
                                                                    , "yd/ys²"
   ...
   /// (3.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareRontosecond = new("yard per square rontosecond"
                                                                    , "yd/rs²"
   ...
   /// (3.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareQuectosecond = new("yard per square quectosecond"
                                                                     , "yd/qs²"
   ...
   /// </summary>
   public static readonly Acceleration MilePerSquarePlanckTime = new("mile per square planck-time"
                                                                   , "mi/tₚ²"
   ...
   /// </summary>
   public static readonly Acceleration MilePerSquareMicrosecond = new("mile per square microsecond"
                                                                    , "mi/μs²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareNanosecond = new("mile per square nanosecond"
                                                                   , "mi/ns²"
                                                                   , YardPerSquareMicrosecond
                                                                   , 1760.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                   , system: "US Customary"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquarePicosecond = new("mile per square picosecond"
                                                                   , "mi/ps²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareFemtosecond = new("mile per square femtosecond"
                                                                    , "mi/fs²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareAttosecond = new("mile per square attosecond"
                                                                   , "mi/as²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareZeptosecond = new("mile per square zeptosecond"
                                                                    , "mi/zs²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareYoctosecond = new("mile per square yoctosecond"
                                                                    , "mi/ys²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareRontosecond = new("mile per square rontosecond"
                                                                    , "mi/rs²"
   ...
   /// (1760.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration MilePerSquareQuectosecond = new("mile per square quectosecond"
                                                                     , "mi/qs²"
   ...
   /// </summary>
   public static readonly Acceleration InchPerSquareMillennium = new("inch per square millennium"
                                                                   , "in/kyr²"
   ...
   /// </summary>
   public static readonly Acceleration FathomPerSquarePlanckTime = new("fathom per square planck-time"
                                                                     , "ftm/tₚ²"
                                                                     , YardPerSquareMicrosecond
                                                                     , 2.0 / (5.391247E-38 * 5.391247E-38)
                                                                     , system: "US Customary"
   ...
   /// </summary>
   public static readonly Acceleration FathomPerSquareMicrosecond = new("fathom per square microsecond"
                                                                      , "ftm/μs²"
                                                                      , YardPerSquareMillisecond
                                                                      , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareNanosecond = new("fathom per square nanosecond"
                                                                     , "ftm/ns²"
                                                                     , YardPerSquareMicrosecond
                                                                     , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquarePicosecond = new("fathom per square picosecond"
                                                                     , "ftm/ps²"
                                                                     , YardPerSquareNanosecond
                                                                     , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareFemtosecond = new("fathom per square femtosecond"
                                                                      , "ftm/fs²"
                                                                      , YardPerSquarePicosecond
                                                                      , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareAttosecond = new("fathom per square attosecond"
                                                                     , "ftm/as²"
                                                                     , YardPerSquareFemtosecond
                                                                     , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                     , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareZeptosecond = new("fathom per square zeptosecond"
                                                                      , "ftm/zs²"
                                                                      , YardPerSquareAttosecond
                                                                      , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareYoctosecond = new("fathom per square yoctosecond"
                                                                      , "ftm/ys²"
                                                                      , YardPerSquareZeptosecond
                                                                      , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareRontosecond = new("fathom per square rontosecond"
                                                                      , "ftm/rs²"
                                                                      , YardPerSquareYoctosecond
                                                                      , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                      , system: "US Customary"
   ...
   /// (2.0)/((1.0/1000.0)*(1.0/1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareQuectosecond = new("fathom per square quectosecond"
                                                                       , "ftm/qs²"
                                                                       , YardPerSquareRontosecond
                                                                       , 2.0 / (1.0 / 1000.0 * (1.0 / 1000.0))
                                                                       , system: "US Customary"
   ...
   /// (120.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration CablePerSquareMillisecond = new("cable per square millisecond"
                                                                     , "cb/ms²"
   ...
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareDecisecond = new("nautical mile per square decisecond"
                                                                           , "nmi/ds²"
                                                                           , SI.Accelerations.MeterPerSquareSecond
                                                                           , 1852.0 / (1.0 / 10.0 * (1.0 / 10.0))
                                                                           , system: "US Customary"
   ...
   /// (1852.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareCentisecond = new("nautical mile per square centisecond"
                                                                            , "nmi/cs²"
   ...
   /// (1852.0)/((1.0/10.0)*(1.0/10.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareMillisecond = new("nautical mile per square millisecond"
                                                                            , "nmi/ms²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareNonillionYears = new("nautical mile per square nonillion years"
                                                                               , "nmi/Qyr²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareQuadrillionYears = new("nautical mile per square quadrillion years"
                                                                                 , "nmi/Pyr²"
   ...
   /// (1852.0)/((10.0)*(10.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareCentury = new("nautical mile per square century"
                                                                        , "nmi/century²"
   ...
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareHour = new("nautical mile per square hour"
                                                                     , "nmi/hr²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareSextillionYears = new("nautical mile per square sextillion years"
                                                                                , "nmi/Zyr²"
   ...
   /// (1852.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration NauticalMilePerSquareMillionYears = new("nautical mile per square million years"
                                                                             , "nmi/Myr²"
   ...
   /// (1.0/72.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareQuintillionYears = new("point per square quintillion years"
                                                                          , "p/Eyr²"
   ...
   /// (1.0/72.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareSextillionYears = new("point per square sextillion years"
                                                                         , "p/Zyr²"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareQuadrillionYears = new("mil per square quadrillion years"
                                                                        , "mil/Pyr²"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareQuintillionYears = new("mil per square quintillion years"
                                                                        , "mil/Eyr²"
                                                                        , InchPerSquareQuadrillionYears
                                                                        , 1.0 / 1000.0 / (1000.0 * 1000.0)
                                                                        , system: "US Customary"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareSextillionYears = new("mil per square sextillion years"
                                                                       , "mil/Zyr²"
                                                                       , InchPerSquareQuintillionYears
                                                                       , 1.0 / 1000.0 / (1000.0 * 1000.0)
                                                                       , system: "US Customary"
   ...
   /// (2.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration FathomPerSquareDecillionYears = new("fathom per square decillion years"
                                                                         , "ftm/decillion yr²"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareSeptillionYears = new("mil per square septillion years"
                                                                       , "mil/Yyr²"
   ...
   /// (3.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration YardPerSquareDecillionYears = new("yard per square decillion years"
                                                                       , "yd/decillion yr²"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareOctillionYears = new("mil per square octillion years"
                                                                      , "mil/Ryr²"
   ...
   /// (12.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration FootPerSquareDecillionYears = new("foot per square decillion years"
                                                                       , "ft/decillion yr²"
   ...
   /// (12.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration PicaPerSquareDecillionYears = new("pica per square decillion years"
                                                                       , "P/decillion yr²"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareNonillionYears = new("mil per square nonillion years"
                                                                      , "mil/Qyr²"
   ...
   /// (1.0/20.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration TwipPerSquareQuadrillionYears = new("twip per square quadrillion years"
                                                                         , "twip/Pyr²"
   ...
   /// (1.0/72.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration PointPerSquareDecillionYears = new("point per square decillion years"
                                                                        , "p/decillion yr²"
                                                                        , InchPerSquareNonillionYears
                                                                        , 1.0 / 72.0 / (1000.0 * 1000.0)
                                                                        , system: "US Customary"
   ...
   /// (1.0/1000.0)/((1000.0)*(1000.0)).
   /// </summary>
   public static readonly Acceleration MilPerSquareDecillionYears = new("mil per square decillion years"
                                                                      , "mil/decillion yr²"
                                                                      , InchPerSquareNonillionYears
                                                                      , 1.0 / 1000.0 / (1000.0 * 1000.0)
                                                                      , system: "US Customary"
   ...
   public static readonly Acceleration LeaguePerSquareBillionYears =
      new("league per square billion years", "le/Gyr²", MilePerSquareMillionYears, 3.0 / (1000.0 * 1000.0), system: "US Customary");
}