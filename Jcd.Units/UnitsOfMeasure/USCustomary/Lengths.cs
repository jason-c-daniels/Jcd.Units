...
public class Lengths : UnitOfMeasureEnumeration<Lengths, Length>
{
   ...
   /// <summary>
   /// A(n) mil. Defined as: (1.0/1000.0) × inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) twip. Defined as: (1.0/20.0) × point + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) foot. Defined as: (12.0) × inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) mile. Defined as: (1760.0) × yard + (0).
   /// </summary>
