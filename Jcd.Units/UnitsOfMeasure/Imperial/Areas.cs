...
public class Areas : UnitOfMeasureEnumeration<Areas, Area>
{
   ...
   /// <summary>
   /// A(n) square barleycorn. Defined as: ((1.0/36.0)*(1.0/36.0)) × square foot + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) square hand. Defined as: ((4.0)*(4.0)) × square inch + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) square furlong. Defined as: ((10.0)*(10.0)) × square chain + (0).
   /// </summary>
   public static readonly Area SquareFurlong = new ("square furlong", "fur²", SquareChain, 10.0 * 10.0, 0);

   /// <summary>
   /// A(n) square mile. Defined as: ((8.0)*(8.0)) × square furlong + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) square cable. Defined as: ((100.0)*(100.0)) × square fathom + (0).
   /// </summary>
