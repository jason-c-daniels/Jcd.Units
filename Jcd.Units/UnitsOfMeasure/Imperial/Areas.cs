...
public class Areas : Enumeration<Areas, Area>
{
   ...
   /// </summary>
   public static readonly Area SquareHand = new ("square hand", "hh^2", SquareInch, 4 * 4, 0);
   ...
   /// </summary>
   public static readonly Area SquareChain = new ("square chain", "ch^2", SquareYard, 22 * 22, 0);

   /// <summary>
   /// A(n) square furlong. Defined in terms of a(n) square chain.
   /// </summary>
   public static readonly Area SquareFurlong = new ("square furlong", "fur^2", SquareChain, 10 * 10, 0);

   /// <summary>
   /// A(n) square mile. Defined in terms of a(n) square furlong.
   /// </summary>
   public static readonly Area SquareMile = new ("square mile", "mi^2", SquareFurlong, 8 * 8, 0);

   /// <summary>
   /// A(n) square league. Defined in terms of a(n) square mile.
   /// </summary>
   public static readonly Area SquareLeague = new ("square league", "lea^2", SquareMile, 3 * 3, 0);

   /// <summary>
   /// A(n) square fathom. Defined in terms of a(n) square foot.
   /// </summary>
   public static readonly Area SquareFathom = new ("square fathom", "ftm^2", SquareFoot, 6 * 6, 0);

   /// <summary>
   /// A(n) square cable. Defined in terms of a(n) square fathom.
   /// </summary>
   public static readonly Area SquareCable = new ("square cable", "cable^2", SquareFathom, 100 * 100, 0);

   /// <summary>
   /// A(n) square nautical mile. Defined in terms of a(n) square cable.
   /// </summary>
   public static readonly Area SquareNauticalMile = new ("square nautical mile", "nmi^2", SquareCable, 10 * 10, 0);
}
