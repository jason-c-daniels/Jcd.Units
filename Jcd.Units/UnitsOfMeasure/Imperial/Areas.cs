...
public class Areas : UnitOfMeasureEnumeration<Areas, Area>
{
   ...
   /// </summary>
   public static readonly Area SquareInch = new("square inch", "in²", SI.Areas.SquareCentimeter, 2.54 * 2.54, system: "Imperial");
   ...
   /// </summary>
   public static readonly Area SquareTwip = new("square twip", "twip²", SquareFoot, 1.0 / 17280.0 * (1.0 / 17280.0), system: "Imperial");

   /// <summary>
   /// square thou defined such that: square foot = th² × (1.0/12000.0)*(1.0/12000.0).
   /// </summary>
   public static readonly Area SquareThou = new("square thou", "th²", SquareFoot, 1.0 / 12000.0 * (1.0 / 12000.0), system: "Imperial");

   /// <summary>
   /// square barleycorn defined such that: square foot = barleycorn² × (1.0/36.0)*(1.0/36.0).
   /// </summary>
   public static readonly Area SquareBarleycorn = new("square barleycorn", "barleycorn²", SquareFoot, 1.0 / 36.0 * (1.0 / 36.0), system: "Imperial");
   ...
   /// </summary>
   public static readonly Area SquareFurlong = new("square furlong", "fur²", SquareChain, 10.0 * 10.0, system: "Imperial");
   ...
   /// </summary>
   public static readonly Area SquareCable = new("square cable", "cable²", SquareFathom, 100.0 * 100.0, system: "Imperial");

   /// <summary>
   /// square nautical mile defined such that: square cable = nmi² × (10.0)*(10.0).
   /// </summary>
   public static readonly Area SquareNauticalMile = new("square nautical mile", "nmi²", SquareCable, 10.0 * 10.0, system: "Imperial");
