...
public class Velocities : UnitOfMeasureEnumeration<Velocities, Velocity>
{
   ...
   public static readonly Velocity FootPerQuectosecond =
            new ("foot per quectosecond", "ft/qs", InchPerRontosecond, 12 / (1.0 / 1000.0));
   ...
   public static readonly Velocity HandPerQuectosecond =
            new ("hand per quectosecond", "hh/qs", InchPerRontosecond, 4.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity ChainPerFemtosecond =
            new ("chain per femtosecond", "ch/fs", YardPerPicosecond, 22.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity ChainPerQuectosecond =
            new ("chain per quectosecond", "ch/qs", YardPerRontosecond, 22.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerDecisecond =
            new ("furlong per decisecond", "fur/ds", ChainPerSecond, 10.0 / (1.0 / 10.0));
   ...
   public static readonly Velocity FurlongPerCentisecond =
            new ("furlong per centisecond", "fur/cs", ChainPerDecisecond, 10.0 / (1.0 / 10.0));
   ...
   public static readonly Velocity FurlongPerMillisecond =
            new ("furlong per millisecond", "fur/ms", ChainPerCentisecond, 10.0 / (1.0 / 10.0));
   ...
   public static readonly Velocity FurlongPerMicrosecond =
            new ("furlong per microsecond", "fur/μs", ChainPerMillisecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerNanosecond =
            new ("furlong per nanosecond", "fur/ns", ChainPerMicrosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerPicosecond =
            new ("furlong per picosecond", "fur/ps", ChainPerNanosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerFemtosecond =
            new ("furlong per femtosecond", "fur/fs", ChainPerPicosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerAttosecond =
            new ("furlong per attosecond", "fur/as", ChainPerFemtosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerZeptosecond =
            new ("furlong per zeptosecond", "fur/zs", ChainPerAttosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerYoctosecond =
            new ("furlong per yoctosecond", "fur/ys", ChainPerZeptosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerRontosecond =
            new ("furlong per rontosecond", "fur/rs", ChainPerYoctosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FurlongPerQuectosecond =
            new ("furlong per quectosecond", "fur/qs", ChainPerRontosecond, 10.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity MilePerQuectosecond =
            new ("mile per quectosecond", "mi/qs", FurlongPerRontosecond, 8.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity LeaguePerYoctosecond =
            new ("league per yoctosecond", "lea/ys", MilePerZeptosecond, 3.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity LeaguePerRontosecond =
            new ("league per rontosecond", "lea/rs", MilePerYoctosecond, 3.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity LeaguePerQuectosecond =
            new ("league per quectosecond", "lea/qs", MilePerRontosecond, 3.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FathomPerYoctosecond =
            new ("fathom per yoctosecond", "ftm/ys", FootPerZeptosecond, 6.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FathomPerRontosecond =
            new ("fathom per rontosecond", "ftm/rs", FootPerYoctosecond, 6.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity FathomPerQuectosecond =
            new ("fathom per quectosecond", "ftm/qs", FootPerRontosecond, 6.0 / (1.0 / 1000.0));
   ...
   public static readonly Velocity NauticalMilePerDecisecond =
            new ("nautical mile per decisecond", "nmi/ds", CablePerSecond, 10.0 / (1.0 / 10.0));
   ...
   public static readonly Velocity NauticalMilePerCentisecond =
            new ("nautical mile per centisecond", "nmi/cs", CablePerDecisecond, 10.0 / (1.0 / 10.0));
   ...
   /// </summary>
   public static readonly Velocity FootPerHour = new ("foot per hour", "ft/hr", InchPerMinute, 12 / 60.0);
   ...
   /// </summary>
   public static readonly Velocity FootPerDay = new ("foot per day", "ft/dy", InchPerHour, 12 / 24.0);
   ...
   /// </summary>
   public static readonly Velocity TwipPerHour = new ("twip per hour", "twip/hr", FootPerMinute, 1.0 / 17280.0 / 60.0);

   /// <summary>
   /// foot per week, defined as: inch per day × (12)/(7.0)
   /// </summary>
   public static readonly Velocity FootPerWeek = new ("foot per week", "ft/wk", InchPerDay, 12 / 7.0);
   ...
   /// </summary>
   public static readonly Velocity FootPerYear = new ("foot per year", "ft/yr", InchPerDay, 12 / 365.2525);
   ...
   public static readonly Velocity BarleycornPerDecade =
            new ("barleycorn per decade", "barleycorn/decade", FootPerYear, 1.0 / 36.0 / 10.0);
   ...
   /// </summary>
   public static readonly Velocity TwipPerDay = new ("twip per day", "twip/dy", FootPerHour, 1.0 / 17280.0 / 24.0);

   /// <summary>
   /// thou per hour, defined as: foot per minute × (1.0/12000.0)/(60.0)
   /// </summary>
   public static readonly Velocity ThouPerHour = new ("thou per hour", "th/hr", FootPerMinute, 1.0 / 12000.0 / 60.0);

   /// <summary>
   /// foot per decade, defined as: inch per year × (12)/(10.0)
   /// </summary>
   public static readonly Velocity FootPerDecade = new ("foot per decade", "ft/decade", InchPerYear, 12 / 10.0);
   ...
   /// </summary>
   public static readonly Velocity FootPerCentury = new ("foot per century", "ft/century", InchPerDecade, 12 / 10.0);

   /// <summary>
   /// chain per minute, defined as: yard per second × (22.0)/(60.0)
   /// </summary>
   public static readonly Velocity ChainPerMinute = new ("chain per minute", "ch/min", YardPerSecond, 22.0 / 60.0);
   ...
   /// </summary>
   public static readonly Velocity TwipPerWeek = new ("twip per week", "twip/wk", FootPerDay, 1.0 / 17280.0 / 7.0);
   ...
   /// </summary>
   public static readonly Velocity FootPerMillennium = new ("foot per millennium", "ft/kyr", InchPerCentury, 12 / 10.0);
   ...
   public static readonly Velocity HandPerMillionYears =
            new ("hand per million years", "hh/Myr", InchPerMillennium, 4.0 / 1000.0);
   ...
   public static readonly Velocity FootPerMillionYears =
            new ("foot per million years", "ft/Myr", InchPerMillennium, 12 / 1000.0);
   ...
   public static readonly Velocity HandPerQuintillionYears =
            new ("hand per quintillion years", "hh/Eyr", InchPerQuadrillionYears, 4.0 / 1000.0);

   /// <summary>
   /// twip per year, defined as: foot per day × (1.0/17280.0)/(365.2525)
   /// </summary>
   public static readonly Velocity TwipPerYear = new ("twip per year", "twip/yr", FootPerDay, 1.0 / 17280.0 / 365.2525);

   /// <summary>
   /// hand per hour, defined as: inch per minute × (4.0)/(60.0)
   /// </summary>
   public static readonly Velocity HandPerHour = new ("hand per hour", "hh/hr", InchPerMinute, 4.0 / 60.0);

   /// <summary>
   /// foot per billion years, defined as: inch per million years × (12)/(1000.0)
   /// </summary>
   public static readonly Velocity FootPerBillionYears =
            new ("foot per billion years", "ft/Gyr", InchPerMillionYears, 12 / 1000.0);
   ...
   public static readonly Velocity FathomPerTrillionYears =
            new ("fathom per trillion years", "ftm/Tyr", FootPerBillionYears, 6.0 / 1000.0);
   ...
   public static readonly Velocity FootPerTrillionYears =
            new ("foot per trillion years", "ft/Tyr", InchPerBillionYears, 12 / 1000.0);

   /// <summary>
   /// fathom per minute, defined as: foot per second × (6.0)/(60.0)
   /// </summary>
   public static readonly Velocity FathomPerMinute = new ("fathom per minute", "ftm/min", FootPerSecond, 6.0 / 60.0);
   ...
   /// </summary>
   public static readonly Velocity HandPerDecade = new ("hand per decade", "hh/decade", InchPerYear, 4.0 / 10.0);
   ...
   /// </summary>
   public static readonly Velocity ThouPerWeek = new ("thou per week", "th/wk", FootPerDay, 1.0 / 12000.0 / 7.0);
   ...
   public static readonly Velocity FootPerQuadrillionYears =
            new ("foot per quadrillion years", "ft/Pyr", InchPerTrillionYears, 12 / 1000.0);
   ...
   public static readonly Velocity FootPerQuintillionYears =
            new ("foot per quintillion years", "ft/Eyr", InchPerQuadrillionYears, 12 / 1000.0);

   /// <summary>
   /// nautical mile per minute, defined as: cable per second × (10.0)/(60.0)
   /// </summary>
   public static readonly Velocity NauticalMilePerMinute =
            new ("nautical mile per minute", "nmi/min", CablePerSecond, 10.0 / 60.0);
   ...
   public static readonly Velocity BarleycornPerMillennium =
            new ("barleycorn per millennium", "barleycorn/kyr", FootPerCentury, 1.0 / 36.0 / 10.0);
   ...
   /// </summary>
   public static readonly Velocity ChainPerHour = new ("chain per hour", "ch/hr", YardPerMinute, 22.0 / 60.0);
   ...
   public static readonly Velocity FootPerSextillionYears =
            new ("foot per sextillion years", "ft/Zyr", InchPerQuintillionYears, 12 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity FathomPerDay = new ("fathom per day", "ftm/dy", FootPerHour, 6.0 / 24.0);
   ...
   public static readonly Velocity HandPerSextillionYears =
            new ("hand per sextillion years", "hh/Zyr", InchPerQuintillionYears, 4.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity ThouPerYear = new ("thou per year", "th/yr", FootPerDay, 1.0 / 12000.0 / 365.2525);

   /// <summary>
   /// hand per day, defined as: inch per hour × (4.0)/(24.0)
   /// </summary>
   public static readonly Velocity HandPerDay = new ("hand per day", "hh/dy", InchPerHour, 4.0 / 24.0);
   ...
   public static readonly Velocity FootPerSeptillionYears =
            new ("foot per septillion years", "ft/Yyr", InchPerSextillionYears, 12 / 1000.0);
   ...
   public static readonly Velocity CablePerMillionYears =
            new ("cable per million years", "cable/Myr", FathomPerMillennium, 100.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity FurlongPerHour = new ("furlong per hour", "fur/hr", ChainPerMinute, 10.0 / 60.0);
   ...
   public static readonly Velocity FootPerOctillionYears =
            new ("foot per octillion years", "ft/Ryr", InchPerSeptillionYears, 12 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity HandPerCentury = new ("hand per century", "hh/century", InchPerDecade, 4.0 / 10.0);
   ...
   public static readonly Velocity ChainPerQuintillionYears =
            new ("chain per quintillion years", "ch/Eyr", YardPerQuadrillionYears, 22.0 / 1000.0);
   ...
   public static readonly Velocity FathomPerSeptillionYears =
            new ("fathom per septillion years", "ftm/Yyr", FootPerSextillionYears, 6.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity CablePerDay = new ("cable per day", "cable/dy", FathomPerHour, 100.0 / 24.0);
   ...
   public static readonly Velocity FathomPerBillionYears =
            new ("fathom per billion years", "ftm/Gyr", FootPerMillionYears, 6.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity MilePerHour = new ("mile per hour", "mi/hr", FurlongPerMinute, 8.0 / 60.0);
   ...
   public static readonly Velocity HandPerTrillionYears =
            new ("hand per trillion years", "hh/Tyr", InchPerBillionYears, 4.0 / 1000.0);

   /// <summary>
   /// fathom per year, defined as: foot per day × (6.0)/(365.2525)
   /// </summary>
   public static readonly Velocity FathomPerYear = new ("fathom per year", "ftm/yr", FootPerDay, 6.0 / 365.2525);
   ...
   public static readonly Velocity NauticalMilePerBillionYears =
            new ("nautical mile per billion years", "nmi/Gyr", CablePerMillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity ChainPerOctillionYears =
            new ("chain per octillion years", "ch/Ryr", YardPerSeptillionYears, 22.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity LeaguePerHour = new ("league per hour", "lea/hr", MilePerMinute, 3.0 / 60.0);
   ...
   public static readonly Velocity FathomPerNonillionYears =
            new ("fathom per nonillion years", "ftm/Qyr", FootPerOctillionYears, 6.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity ChainPerDay = new ("chain per day", "ch/dy", YardPerHour, 22.0 / 24.0);
   ...
   public static readonly Velocity FathomPerQuadrillionYears =
            new ("fathom per quadrillion years", "ftm/Pyr", FootPerTrillionYears, 6.0 / 1000.0);
   ...
   public static readonly Velocity CablePerTrillionYears =
            new ("cable per trillion years", "cable/Tyr", FathomPerBillionYears, 100.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity FurlongPerYear = new ("furlong per year", "fur/yr", ChainPerDay, 10.0 / 365.2525);
   ...
   /// </summary>
   public static readonly Velocity CablePerYear = new ("cable per year", "cable/yr", FathomPerDay, 100.0 / 365.2525);
   ...
   /// </summary>
   public static readonly Velocity ChainPerDecade = new ("chain per decade", "ch/decade", YardPerYear, 22.0 / 10.0);
   ...
   /// </summary>
   public static readonly Velocity FurlongPerDay = new ("furlong per day", "fur/dy", ChainPerHour, 10.0 / 24.0);
   ...
   /// </summary>
   public static readonly Velocity CablePerHour = new ("cable per hour", "cable/hr", FathomPerMinute, 100.0 / 60.0);
   ...
   public static readonly Velocity ChainPerSextillionYears =
            new ("chain per sextillion years", "ch/Zyr", YardPerQuintillionYears, 22.0 / 1000.0);
   ...
   public static readonly Velocity MilePerSeptillionYears =
            new ("mile per septillion years", "mi/Yyr", FurlongPerSextillionYears, 8.0 / 1000.0);
   ...
   public static readonly Velocity NauticalMilePerMillionYears =
            new ("nautical mile per million years", "nmi/Myr", CablePerMillennium, 10.0 / 1000.0);
   ...
   public static readonly Velocity FathomPerSextillionYears =
            new ("fathom per sextillion years", "ftm/Zyr", FootPerQuintillionYears, 6.0 / 1000.0);

   /// <summary>
   /// fathom per million years, defined as: foot per millennium × (6.0)/(1000.0)
   /// </summary>
   public static readonly Velocity FathomPerMillionYears =
            new ("fathom per million years", "ftm/Myr", FootPerMillennium, 6.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerNonillionYears =
            new ("furlong per nonillion years", "fur/Qyr", ChainPerOctillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity NauticalMilePerHour =
            new ("nautical mile per hour", "nmi/hr", CablePerMinute, 10.0 / 60.0);

   /// <summary>
   /// chain per million years, defined as: yard per millennium × (22.0)/(1000.0)
   /// </summary>
   public static readonly Velocity ChainPerMillionYears =
            new ("chain per million years", "ch/Myr", YardPerMillennium, 22.0 / 1000.0);

   /// <summary>
   /// mile per year, defined as: furlong per day × (8.0)/(365.2525)
   /// </summary>
   public static readonly Velocity MilePerYear = new ("mile per year", "mi/yr", FurlongPerDay, 8.0 / 365.2525);
   ...
   public static readonly Velocity ChainPerNonillionYears =
            new ("chain per nonillion years", "ch/Qyr", YardPerOctillionYears, 22.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity MilePerDay = new ("mile per day", "mi/dy", FurlongPerHour, 8.0 / 24.0);
   ...
   public static readonly Velocity CablePerBillionYears =
            new ("cable per billion years", "cable/Gyr", FathomPerMillionYears, 100.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerSeptillionYears =
            new ("furlong per septillion years", "fur/Yyr", ChainPerSextillionYears, 10.0 / 1000.0);

   /// <summary>
   /// chain per week, defined as: yard per day × (22.0)/(7.0)
   /// </summary>
   public static readonly Velocity ChainPerWeek = new ("chain per week", "ch/wk", YardPerDay, 22.0 / 7.0);
   ...
   public static readonly Velocity NauticalMilePerYear =
            new ("nautical mile per year", "nmi/yr", CablePerDay, 10.0 / 365.2525);
   ...
   public static readonly Velocity FathomPerOctillionYears =
            new ("fathom per octillion years", "ftm/Ryr", FootPerSeptillionYears, 6.0 / 1000.0);
   ...
   public static readonly Velocity ChainPerQuadrillionYears =
            new ("chain per quadrillion years", "ch/Pyr", YardPerTrillionYears, 22.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity CablePerWeek = new ("cable per week", "cable/wk", FathomPerDay, 100.0 / 7.0);
   ...
   /// </summary>
   public static readonly Velocity LeaguePerDay = new ("league per day", "lea/dy", MilePerHour, 3.0 / 24.0);
   ...
   public static readonly Velocity NauticalMilePerMillennium =
            new ("nautical mile per millennium", "nmi/kyr", CablePerCentury, 10.0 / 10.0);
   ...
   public static readonly Velocity LeaguePerOctillionYears =
            new ("league per octillion years", "lea/Ryr", MilePerSeptillionYears, 3.0 / 1000.0);
   ...
   public static readonly Velocity ChainPerSeptillionYears =
            new ("chain per septillion years", "ch/Yyr", YardPerSextillionYears, 22.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity LeaguePerYear = new ("league per year", "lea/yr", MilePerDay, 3.0 / 365.2525);
   ...
   /// </summary>
   public static readonly Velocity FurlongPerWeek = new ("furlong per week", "fur/wk", ChainPerDay, 10.0 / 7.0);
   ...
   public static readonly Velocity NauticalMilePerTrillionYears =
            new ("nautical mile per trillion years", "nmi/Tyr", CablePerBillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity ChainPerBillionYears =
            new ("chain per billion years", "ch/Gyr", YardPerMillionYears, 22.0 / 1000.0);
   ...
   public static readonly Velocity MilePerOctillionYears =
            new ("mile per octillion years", "mi/Ryr", FurlongPerSeptillionYears, 8.0 / 1000.0);
   ...
   public static readonly Velocity NauticalMilePerWeek =
            new ("nautical mile per week", "nmi/wk", CablePerDay, 10.0 / 7.0);
   ...
   public static readonly Velocity MilePerSextillionYears =
            new ("mile per sextillion years", "mi/Zyr", FurlongPerQuintillionYears, 8.0 / 1000.0);
   ...
   /// </summary>
   public static readonly Velocity ChainPerYear = new ("chain per year", "ch/yr", YardPerDay, 22.0 / 365.2525);
   ...
   /// </summary>
   public static readonly Velocity MilePerDecade = new ("mile per decade", "mi/decade", FurlongPerYear, 8.0 / 10.0);

   /// <summary>
   /// nautical mile per century, defined as: cable per decade × (10.0)/(10.0)
   /// </summary>
   public static readonly Velocity NauticalMilePerCentury =
            new ("nautical mile per century", "nmi/century", CablePerDecade, 10.0 / 10.0);
   ...
   public static readonly Velocity FurlongPerOctillionYears =
            new ("furlong per octillion years", "fur/Ryr", ChainPerSeptillionYears, 10.0 / 1000.0);

   /// <summary>
   /// mile per week, defined as: furlong per day × (8.0)/(7.0)
   /// </summary>
   public static readonly Velocity MilePerWeek = new ("mile per week", "mi/wk", FurlongPerDay, 8.0 / 7.0);
   ...
   public static readonly Velocity LeaguePerSeptillionYears =
            new ("league per septillion years", "lea/Yyr", MilePerSextillionYears, 3.0 / 1000.0);

   /// <summary>
   /// league per week, defined as: mile per day × (3.0)/(7.0)
   /// </summary>
   public static readonly Velocity LeaguePerWeek = new ("league per week", "lea/wk", MilePerDay, 3.0 / 7.0);
   ...
   public static readonly Velocity ChainPerTrillionYears =
            new ("chain per trillion years", "ch/Tyr", YardPerBillionYears, 22.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerQuadrillionYears =
            new ("furlong per quadrillion years", "fur/Pyr", ChainPerTrillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity LeaguePerNonillionYears =
            new ("league per nonillion years", "lea/Qyr", MilePerOctillionYears, 3.0 / 1000.0);

   /// <summary>
   /// nautical mile per decade, defined as: cable per year × (10.0)/(10.0)
   /// </summary>
   public static readonly Velocity NauticalMilePerDecade =
            new ("nautical mile per decade", "nmi/decade", CablePerYear, 10.0 / 10.0);

   /// <summary>
   /// league per decade, defined as: mile per year × (3.0)/(10.0)
   /// </summary>
   public static readonly Velocity LeaguePerDecade = new ("league per decade", "lea/decade", MilePerYear, 3.0 / 10.0);
   ...
   public static readonly Velocity MilePerNonillionYears =
            new ("mile per nonillion years", "mi/Qyr", FurlongPerOctillionYears, 8.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerBillionYears =
            new ("furlong per billion years", "fur/Gyr", ChainPerMillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity MilePerQuintillionYears =
            new ("mile per quintillion years", "mi/Eyr", FurlongPerQuadrillionYears, 8.0 / 1000.0);
   ...
   public static readonly Velocity MilePerTrillionYears =
            new ("mile per trillion years", "mi/Tyr", FurlongPerBillionYears, 8.0 / 1000.0);

   /// <summary>
   /// furlong per millennium, defined as: chain per century × (10.0)/(10.0)
   /// </summary>
   public static readonly Velocity FurlongPerMillennium =
            new ("furlong per millennium", "fur/kyr", ChainPerCentury, 10.0 / 10.0);
   ...
   public static readonly Velocity LeaguePerQuadrillionYears =
            new ("league per quadrillion years", "lea/Pyr", MilePerTrillionYears, 3.0 / 1000.0);
   ...
   public static readonly Velocity LeaguePerSextillionYears =
            new ("league per sextillion years", "lea/Zyr", MilePerQuintillionYears, 3.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerTrillionYears =
            new ("furlong per trillion years", "fur/Tyr", ChainPerBillionYears, 10.0 / 1000.0);
   ...
   public static readonly Velocity MilePerQuadrillionYears =
            new ("mile per quadrillion years", "mi/Pyr", FurlongPerTrillionYears, 8.0 / 1000.0);
   ...
   public static readonly Velocity FurlongPerMillionYears =
            new ("furlong per million years", "fur/Myr", ChainPerMillennium, 10.0 / 1000.0);
   ...
   public static readonly Velocity LeaguePerQuintillionYears =
            new ("league per quintillion years", "lea/Eyr", MilePerQuadrillionYears, 3.0 / 1000.0);

   /// <summary>
   /// mile per million years, defined as: furlong per millennium × (8.0)/(1000.0)
   /// </summary>
   public static readonly Velocity MilePerMillionYears =
            new ("mile per million years", "mi/Myr", FurlongPerMillennium, 8.0 / 1000.0);
   ...
   public static readonly Velocity LeaguePerBillionYears =
            new ("league per billion years", "lea/Gyr", MilePerMillionYears, 3.0 / 1000.0);
   ...
   public static readonly Velocity MilePerBillionYears =
            new ("mile per billion years", "mi/Gyr", FurlongPerMillionYears, 8.0 / 1000.0);

   /// <summary>
   /// league per million years, defined as: mile per millennium × (3.0)/(1000.0)
   /// </summary>
   public static readonly Velocity LeaguePerMillionYears =
            new ("league per million years", "lea/Myr", MilePerMillennium, 3.0 / 1000.0);
   ...
   public static readonly Velocity LeaguePerTrillionYears =
            new ("league per trillion years", "lea/Tyr", MilePerBillionYears, 3.0 / 1000.0);

   /// <summary>
   /// league per millennium, defined as: mile per century × (3.0)/(10.0)
   /// </summary>
   public static readonly Velocity LeaguePerMillennium =
            new ("league per millennium", "lea/kyr", MilePerCentury, 3.0 / 10.0);
}
