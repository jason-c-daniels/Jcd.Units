...
public class Durations : Enumeration<Durations,Duration>
{
    ...
    /// <summary>
    /// A(n) decisecond. It's defined in terms of a(n) second.
    /// </summary>
    ...
    /// <summary>
    /// A(n) millisecond. It's defined in terms of a(n) centisecond.
    /// </summary>
    public static readonly Duration Millisecond = new ("millisecond", "ms", Centisecond, 1.0/10.0,0);
    
    /// <summary>
    /// A(n) microsecond. It's defined in terms of a(n) millisecond.
    /// </summary>
    ...
    /// <summary>
    /// A(n) femtosecond. It's defined in terms of a(n) picosecond.
    /// </summary>
    ...
    /// <summary>
    /// A(n) zeptosecond. It's defined in terms of a(n) attosecond.
    /// </summary>
    ...
    /// <summary>
    /// A(n) quectosecond. It's defined in terms of a(n) rontosecond.
    /// </summary>
    ...
    /// <summary>
    /// A(n) yottasecond. It's defined in terms of a(n) zettasecond.
    /// </summary>
    ...
    /// <summary>
    /// A(n) day. It's defined in terms of a(n) hour.
    /// </summary>
    public static readonly Duration Day = new ("day", "dy", Hour, 24,0);
    
    /// <summary>
    /// A(n) week. It's defined in terms of a(n) day.
    /// </summary>
    ...
    /// <summary>
    /// A(n) million years. It's defined in terms of a(n) millennium.
    /// </summary>
    public static readonly Duration MillionYears = new ("million years", "Myr", Millennium, 1000,0);
    
    /// <summary>
    /// A(n) billion years. It's defined in terms of a(n) million years.
    /// </summary>
    ...
    /// <summary>
    /// A(n) septillion years. It's defined in terms of a(n) sextillion years.
    /// </summary>
    public static readonly Duration SeptillionYears = new ("septillion years", "Yyr", SextillionYears, 1000,0);
    
    /// <summary>
    /// A(n) planck-time. It's defined in terms of a(n) yoctosecond.
    /// </summary>
