...
public class LuminousIntensities : UnitOfMeasureEnumeration<LuminousIntensities, LuminousIntensity>
{
   ...
   /// </summary>
   public static readonly LuminousIntensity Decicandela = new ("decicandela", "dcd", Candela, 1.0 / 10.0);

   /// <summary>
   /// centicandela, defined as: decicandela × 1.0/10.0
   /// </summary>
   public static readonly LuminousIntensity Centicandela = new ("centicandela", "ccd", Decicandela, 1.0 / 10.0);

   /// <summary>
   /// millicandela, defined as: centicandela × 1.0/10.0
   /// </summary>
   public static readonly LuminousIntensity Millicandela = new ("millicandela", "mcd", Centicandela, 1.0 / 10.0);

   /// <summary>
   /// microcandela, defined as: millicandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Microcandela = new ("microcandela", "μcd", Millicandela, 1.0 / 1000.0);

   /// <summary>
   /// nanocandela, defined as: microcandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Nanocandela = new ("nanocandela", "ncd", Microcandela, 1.0 / 1000.0);

   /// <summary>
   /// picocandela, defined as: nanocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Picocandela = new ("picocandela", "pcd", Nanocandela, 1.0 / 1000.0);

   /// <summary>
   /// femtocandela, defined as: picocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Femtocandela = new ("femtocandela", "fcd", Picocandela, 1.0 / 1000.0);

   /// <summary>
   /// attocandela, defined as: femtocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Attocandela = new ("attocandela", "acd", Femtocandela, 1.0 / 1000.0);

   /// <summary>
   /// zeptocandela, defined as: attocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Zeptocandela = new ("zeptocandela", "zcd", Attocandela, 1.0 / 1000.0);

   /// <summary>
   /// yoctocandela, defined as: zeptocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Yoctocandela = new ("yoctocandela", "ycd", Zeptocandela, 1.0 / 1000.0);

   /// <summary>
   /// rontocandela, defined as: yoctocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Rontocandela = new ("rontocandela", "rcd", Yoctocandela, 1.0 / 1000.0);

   /// <summary>
   /// quectocandela, defined as: rontocandela × 1.0/1000.0
   /// </summary>
   public static readonly LuminousIntensity Quectocandela = new ("quectocandela", "qcd", Rontocandela, 1.0 / 1000.0);
