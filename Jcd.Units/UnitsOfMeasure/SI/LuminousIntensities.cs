...
public class LuminousIntensities : Enumeration<LuminousIntensities,LuminousIntensity>
{
    ...
    /// <summary>
    /// A(n) millicandela. It's defined in terms of a(n) centicandela.
    /// </summary>
    ...
    /// <summary>
    /// A(n) yoctocandela. It's defined in terms of a(n) zeptocandela.
    /// </summary>
    ...
    /// <summary>
    /// A(n) dekacandela. It's defined in terms of a(n) candela.
    /// </summary>
    ...
    /// <summary>
    /// A(n) gigacandela. It's defined in terms of a(n) megacandela.
    /// </summary>
    ...
    /// <summary>
    /// A(n) zettacandela. It's defined in terms of a(n) exacandela.
    /// </summary>
    ...
    /// <summary>
    /// A(n) ronnacandela. It's defined in terms of a(n) yottacandela.
    /// </summary>
