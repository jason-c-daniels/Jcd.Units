...
public class ElectricalCurrents : UnitOfMeasureEnumeration<ElectricalCurrents, ElectricalCurrent>
{
   ...
   /// </summary>
   public static readonly ElectricalCurrent Deciampere = new ("deciampere", "dA", Ampere, 1.0 / 10.0);

   /// <summary>
   /// centiampere, defined as: deciampere × 1.0/10.0
   /// </summary>
   public static readonly ElectricalCurrent Centiampere = new ("centiampere", "cA", Deciampere, 1.0 / 10.0);

   /// <summary>
   /// milliampere, defined as: centiampere × 1.0/10.0
   /// </summary>
   public static readonly ElectricalCurrent Milliampere = new ("milliampere", "mA", Centiampere, 1.0 / 10.0);

   /// <summary>
   /// microampere, defined as: milliampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Microampere = new ("microampere", "μA", Milliampere, 1.0 / 1000.0);

   /// <summary>
   /// nanoampere, defined as: microampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Nanoampere = new ("nanoampere", "nA", Microampere, 1.0 / 1000.0);

   /// <summary>
   /// picoampere, defined as: nanoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Picoampere = new ("picoampere", "pA", Nanoampere, 1.0 / 1000.0);

   /// <summary>
   /// femtoampere, defined as: picoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Femtoampere = new ("femtoampere", "fA", Picoampere, 1.0 / 1000.0);

   /// <summary>
   /// attoampere, defined as: femtoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Attoampere = new ("attoampere", "aA", Femtoampere, 1.0 / 1000.0);

   /// <summary>
   /// zeptoampere, defined as: attoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Zeptoampere = new ("zeptoampere", "zA", Attoampere, 1.0 / 1000.0);

   /// <summary>
   /// yoctoampere, defined as: zeptoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Yoctoampere = new ("yoctoampere", "yA", Zeptoampere, 1.0 / 1000.0);

   /// <summary>
   /// rontoampere, defined as: yoctoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Rontoampere = new ("rontoampere", "rA", Yoctoampere, 1.0 / 1000.0);

   /// <summary>
   /// quectoampere, defined as: rontoampere × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalCurrent Quectoampere = new ("quectoampere", "qA", Rontoampere, 1.0 / 1000.0);
