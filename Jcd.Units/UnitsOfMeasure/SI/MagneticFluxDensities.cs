...
public class MagneticFluxDensities : UnitOfMeasureEnumeration<MagneticFluxDensities, MagneticFluxDensity>
{
   ...
   /// </summary>
   public static readonly MagneticFluxDensity Decitesla = new ("decitesla", "dT", Tesla, 1.0 / 10.0);

   /// <summary>
   /// centitesla, defined as: decitesla × 1.0/10.0
   /// </summary>
   public static readonly MagneticFluxDensity Centitesla = new ("centitesla", "cT", Decitesla, 1.0 / 10.0);

   /// <summary>
   /// millitesla, defined as: centitesla × 1.0/10.0
   /// </summary>
   public static readonly MagneticFluxDensity Millitesla = new ("millitesla", "mT", Centitesla, 1.0 / 10.0);

   /// <summary>
   /// microtesla, defined as: millitesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Microtesla = new ("microtesla", "μT", Millitesla, 1.0 / 1000.0);

   /// <summary>
   /// nanotesla, defined as: microtesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Nanotesla = new ("nanotesla", "nT", Microtesla, 1.0 / 1000.0);

   /// <summary>
   /// picotesla, defined as: nanotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Picotesla = new ("picotesla", "pT", Nanotesla, 1.0 / 1000.0);

   /// <summary>
   /// femtotesla, defined as: picotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Femtotesla = new ("femtotesla", "fT", Picotesla, 1.0 / 1000.0);

   /// <summary>
   /// attotesla, defined as: femtotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Attotesla = new ("attotesla", "aT", Femtotesla, 1.0 / 1000.0);

   /// <summary>
   /// zeptotesla, defined as: attotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Zeptotesla = new ("zeptotesla", "zT", Attotesla, 1.0 / 1000.0);

   /// <summary>
   /// yoctotesla, defined as: zeptotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Yoctotesla = new ("yoctotesla", "yT", Zeptotesla, 1.0 / 1000.0);

   /// <summary>
   /// rontotesla, defined as: yoctotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Rontotesla = new ("rontotesla", "rT", Yoctotesla, 1.0 / 1000.0);

   /// <summary>
   /// quectotesla, defined as: rontotesla × 1.0/1000.0
   /// </summary>
   public static readonly MagneticFluxDensity Quectotesla = new ("quectotesla", "qT", Rontotesla, 1.0 / 1000.0);
