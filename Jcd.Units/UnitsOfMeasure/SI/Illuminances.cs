...
public class Illuminances : UnitOfMeasureEnumeration<Illuminances, Illuminance>
{
   ...
   /// </summary>
   public static readonly Illuminance Decilux = new ("decilux", "dlx", Lux, 1.0 / 10.0);

   /// <summary>
   /// centilux, defined as: decilux × 1.0/10.0
   /// </summary>
   public static readonly Illuminance Centilux = new ("centilux", "clx", Decilux, 1.0 / 10.0);

   /// <summary>
   /// millilux, defined as: centilux × 1.0/10.0
   /// </summary>
   public static readonly Illuminance Millilux = new ("millilux", "mlx", Centilux, 1.0 / 10.0);

   /// <summary>
   /// microlux, defined as: millilux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Microlux = new ("microlux", "μlx", Millilux, 1.0 / 1000.0);

   /// <summary>
   /// nanolux, defined as: microlux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Nanolux = new ("nanolux", "nlx", Microlux, 1.0 / 1000.0);

   /// <summary>
   /// picolux, defined as: nanolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Picolux = new ("picolux", "plx", Nanolux, 1.0 / 1000.0);

   /// <summary>
   /// femtolux, defined as: picolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Femtolux = new ("femtolux", "flx", Picolux, 1.0 / 1000.0);

   /// <summary>
   /// attolux, defined as: femtolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Attolux = new ("attolux", "alx", Femtolux, 1.0 / 1000.0);

   /// <summary>
   /// zeptolux, defined as: attolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Zeptolux = new ("zeptolux", "zlx", Attolux, 1.0 / 1000.0);

   /// <summary>
   /// yoctolux, defined as: zeptolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Yoctolux = new ("yoctolux", "ylx", Zeptolux, 1.0 / 1000.0);

   /// <summary>
   /// rontolux, defined as: yoctolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Rontolux = new ("rontolux", "rlx", Yoctolux, 1.0 / 1000.0);

   /// <summary>
   /// quectolux, defined as: rontolux × 1.0/1000.0
   /// </summary>
   public static readonly Illuminance Quectolux = new ("quectolux", "qlx", Rontolux, 1.0 / 1000.0);
