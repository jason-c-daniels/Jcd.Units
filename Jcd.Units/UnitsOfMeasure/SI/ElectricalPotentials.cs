...
public class ElectricalPotentials : UnitOfMeasureEnumeration<ElectricalPotentials, ElectricalPotential>
{
   ...
   /// </summary>
   public static readonly ElectricalPotential Decivolt = new ("decivolt", "dV", Volt, 1.0 / 10.0);

   /// <summary>
   /// centivolt, defined as: decivolt × 1.0/10.0
   /// </summary>
   public static readonly ElectricalPotential Centivolt = new ("centivolt", "cV", Decivolt, 1.0 / 10.0);

   /// <summary>
   /// millivolt, defined as: centivolt × 1.0/10.0
   /// </summary>
   public static readonly ElectricalPotential Millivolt = new ("millivolt", "mV", Centivolt, 1.0 / 10.0);

   /// <summary>
   /// microvolt, defined as: millivolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Microvolt = new ("microvolt", "μV", Millivolt, 1.0 / 1000.0);

   /// <summary>
   /// nanovolt, defined as: microvolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Nanovolt = new ("nanovolt", "nV", Microvolt, 1.0 / 1000.0);

   /// <summary>
   /// picovolt, defined as: nanovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Picovolt = new ("picovolt", "pV", Nanovolt, 1.0 / 1000.0);

   /// <summary>
   /// femtovolt, defined as: picovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Femtovolt = new ("femtovolt", "fV", Picovolt, 1.0 / 1000.0);

   /// <summary>
   /// attovolt, defined as: femtovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Attovolt = new ("attovolt", "aV", Femtovolt, 1.0 / 1000.0);

   /// <summary>
   /// zeptovolt, defined as: attovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Zeptovolt = new ("zeptovolt", "zV", Attovolt, 1.0 / 1000.0);

   /// <summary>
   /// yoctovolt, defined as: zeptovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Yoctovolt = new ("yoctovolt", "yV", Zeptovolt, 1.0 / 1000.0);

   /// <summary>
   /// rontovolt, defined as: yoctovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Rontovolt = new ("rontovolt", "rV", Yoctovolt, 1.0 / 1000.0);

   /// <summary>
   /// quectovolt, defined as: rontovolt × 1.0/1000.0
   /// </summary>
   public static readonly ElectricalPotential Quectovolt = new ("quectovolt", "qV", Rontovolt, 1.0 / 1000.0);
