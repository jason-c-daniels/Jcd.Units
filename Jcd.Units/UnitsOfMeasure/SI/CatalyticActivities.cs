...
public class CatalyticActivities : UnitOfMeasureEnumeration<CatalyticActivities, CatalyticActivity>
{
   ...
   /// </summary>
   public static readonly CatalyticActivity Centikatal = new("centikatal", "ckat", Decikatal, 1.0 / 10.0, system: "SI");
   
   /// <summary>
   /// millikatal defined such that: centikatal = mkat × 1.0/10.0.
   /// </summary>
   public static readonly CatalyticActivity Millikatal = new("millikatal", "mkat", Centikatal, 1.0 / 10.0, system: "SI");
   
   /// <summary>
   /// microkatal defined such that: millikatal = μkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Microkatal = new("microkatal", "μkat", Millikatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// nanokatal defined such that: microkatal = nkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Nanokatal = new("nanokatal", "nkat", Microkatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// picokatal defined such that: nanokatal = pkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Picokatal = new("picokatal", "pkat", Nanokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// femtokatal defined such that: picokatal = fkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Femtokatal = new("femtokatal", "fkat", Picokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// attokatal defined such that: femtokatal = akat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Attokatal = new("attokatal", "akat", Femtokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// zeptokatal defined such that: attokatal = zkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Zeptokatal = new("zeptokatal", "zkat", Attokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// yoctokatal defined such that: zeptokatal = ykat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Yoctokatal = new("yoctokatal", "ykat", Zeptokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// rontokatal defined such that: yoctokatal = rkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Rontokatal = new("rontokatal", "rkat", Yoctokatal, 1.0 / 1000.0, system: "SI");
   
   /// <summary>
   /// quectokatal defined such that: rontokatal = qkat × 1.0/1000.0.
   /// </summary>
   public static readonly CatalyticActivity Quectokatal = new("quectokatal", "qkat", Rontokatal, 1.0 / 1000.0, system: "SI");
