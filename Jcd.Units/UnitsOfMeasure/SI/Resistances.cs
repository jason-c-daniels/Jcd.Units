...
public class Resistances : UnitOfMeasureEnumeration<Resistances, Resistance>
{
   ...
   /// <summary>
   /// A(n) deciohm. Defined as: (1.0/10.0) × ohm + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) rontoohm. Defined as: (1.0/1000.0) × yoctoohm + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) megaohm. Defined as: (1000.0) × kiloohm + (0).
   /// </summary>
   ...
   /// <summary>
   /// A(n) teraohm. Defined as: (1000.0) × gigaohm + (0).
   /// </summary>
