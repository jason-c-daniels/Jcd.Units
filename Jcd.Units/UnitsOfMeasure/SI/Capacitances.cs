...
public class Capacitances : UnitOfMeasureEnumeration<Capacitances, Capacitance>
{
   ...
   /// </summary>
   public static readonly Capacitance Decifarad = new ("decifarad", "dF", Farad, 1.0 / 10.0);

   /// <summary>
   /// centifarad, defined as: decifarad × 1.0/10.0
   /// </summary>
   public static readonly Capacitance Centifarad = new ("centifarad", "cF", Decifarad, 1.0 / 10.0);

   /// <summary>
   /// millifarad, defined as: centifarad × 1.0/10.0
   /// </summary>
   public static readonly Capacitance Millifarad = new ("millifarad", "mF", Centifarad, 1.0 / 10.0);

   /// <summary>
   /// microfarad, defined as: millifarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Microfarad = new ("microfarad", "μF", Millifarad, 1.0 / 1000.0);

   /// <summary>
   /// nanofarad, defined as: microfarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Nanofarad = new ("nanofarad", "nF", Microfarad, 1.0 / 1000.0);

   /// <summary>
   /// picofarad, defined as: nanofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Picofarad = new ("picofarad", "pF", Nanofarad, 1.0 / 1000.0);

   /// <summary>
   /// femtofarad, defined as: picofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Femtofarad = new ("femtofarad", "fF", Picofarad, 1.0 / 1000.0);

   /// <summary>
   /// attofarad, defined as: femtofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Attofarad = new ("attofarad", "aF", Femtofarad, 1.0 / 1000.0);

   /// <summary>
   /// zeptofarad, defined as: attofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Zeptofarad = new ("zeptofarad", "zF", Attofarad, 1.0 / 1000.0);

   /// <summary>
   /// yoctofarad, defined as: zeptofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Yoctofarad = new ("yoctofarad", "yF", Zeptofarad, 1.0 / 1000.0);

   /// <summary>
   /// rontofarad, defined as: yoctofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Rontofarad = new ("rontofarad", "rF", Yoctofarad, 1.0 / 1000.0);

   /// <summary>
   /// quectofarad, defined as: rontofarad × 1.0/1000.0
   /// </summary>
   public static readonly Capacitance Quectofarad = new ("quectofarad", "qF", Rontofarad, 1.0 / 1000.0);
