...
public class Velocities : UnitOfMeasureEnumeration<Velocities, Velocity>
{
   ...
   /// </summary>
   public static readonly Velocity SpeedOfLight = new("speed of light", "c", SI.Velocities.MeterPerSecond, 299_792_458, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerSecond =
      new("planck-length per second", "ℓₚ/s", SI.Velocities.MeterPerSecond, 1.616255E-35 / 1.0, system: "Theoretical Physics");

   /// <summary>
   /// planck-length per planck-time defined such that: SI meter per microsecond = ℓₚ/tₚ × (1.616255E-35)/(5.391247E-38).
   /// </summary>
   public static readonly Velocity PlanckLengthPerPlanckTime = new("planck-length per planck-time"
                                                                 , "ℓₚ/tₚ"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerDecisecond = new("planck-length per decisecond"
                                                                 , "ℓₚ/ds"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerCentisecond = new("planck-length per centisecond"
                                                                  , "ℓₚ/cs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerMillisecond = new("planck-length per millisecond"
                                                                  , "ℓₚ/ms"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerMicrosecond = new("planck-length per microsecond"
                                                                  , "ℓₚ/μs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerNanosecond = new("planck-length per nanosecond"
                                                                 , "ℓₚ/ns"
                                                                 , SI.Velocities.MeterPerMicrosecond
                                                                 , 1.616255E-35 / (1.0 / 1000.0)
                                                                 , system: "Theoretical Physics"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerPicosecond = new("planck-length per picosecond"
                                                                 , "ℓₚ/ps"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerFemtosecond = new("planck-length per femtosecond"
                                                                  , "ℓₚ/fs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerAttosecond = new("planck-length per attosecond"
                                                                 , "ℓₚ/as"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerZeptosecond = new("planck-length per zeptosecond"
                                                                  , "ℓₚ/zs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerYoctosecond = new("planck-length per yoctosecond"
                                                                  , "ℓₚ/ys"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerRontosecond = new("planck-length per rontosecond"
                                                                  , "ℓₚ/rs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerQuectosecond = new("planck-length per quectosecond"
                                                                   , "ℓₚ/qs"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerMinute =
      new("planck-length per minute", "ℓₚ/min", SI.Velocities.MeterPerSecond, 1.616255E-35 / 60.0, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerHour =
      new("planck-length per hour", "ℓₚ/hr", SI.Velocities.MeterPerMinute, 1.616255E-35 / 60.0, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerDay =
      new("planck-length per day", "ℓₚ/dy", SI.Velocities.MeterPerHour, 1.616255E-35 / 24.0, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerWeek =
      new("planck-length per week", "ℓₚ/wk", SI.Velocities.MeterPerDay, 1.616255E-35 / 7.0, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerYear =
      new("planck-length per year", "ℓₚ/yr", SI.Velocities.MeterPerDay, 1.616255E-35 / 365.2525, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerDecade =
      new("planck-length per decade", "ℓₚ/decade", SI.Velocities.MeterPerYear, 1.616255E-35 / 10.0, system: "Theoretical Physics");
   ...
   public static readonly Velocity PlanckLengthPerCentury =
      new("planck-length per century", "ℓₚ/century", SI.Velocities.MeterPerDecade, 1.616255E-35 / 10.0, system: "Theoretical Physics");

   /// <summary>
   /// planck-length per millennium defined such that: SI meter per century = ℓₚ/kyr × (1.616255E-35)/(10.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerMillennium =
      new("planck-length per millennium", "ℓₚ/kyr", SI.Velocities.MeterPerCentury, 1.616255E-35 / 10.0, system: "Theoretical Physics");

   /// <summary>
   /// planck-length per million years defined such that: SI meter per millennium = ℓₚ/Myr × (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerMillionYears = new("planck-length per million years"
                                                                   , "ℓₚ/Myr"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerBillionYears = new("planck-length per billion years"
                                                                   , "ℓₚ/Gyr"
   ...
   /// </summary>
   public static readonly Velocity PlanckLengthPerTrillionYears = new("planck-length per trillion years"
                                                                    , "ℓₚ/Tyr"
   ...
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerQuadrillionYears = new("planck-length per quadrillion years"
                                                                       , "ℓₚ/Pyr"
   ...
   /// <summary>
   /// planck-length per quintillion years defined such that: SI meter per quadrillion years = ℓₚ/Eyr ×
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerQuintillionYears = new("planck-length per quintillion years"
                                                                       , "ℓₚ/Eyr"
   ...
   /// <summary>
   /// planck-length per sextillion years defined such that: SI meter per quintillion years = ℓₚ/Zyr ×
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerSextillionYears = new("planck-length per sextillion years"
                                                                      , "ℓₚ/Zyr"
   ...
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerSeptillionYears = new("planck-length per septillion years"
                                                                      , "ℓₚ/Yyr"
   ...
   /// <summary>
   /// planck-length per octillion years defined such that: SI meter per septillion years = ℓₚ/Ryr ×
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerOctillionYears = new("planck-length per octillion years"
                                                                     , "ℓₚ/Ryr"
   ...
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerNonillionYears = new("planck-length per nonillion years"
                                                                     , "ℓₚ/Qyr"
   ...
   /// (1.616255E-35)/(1000.0).
   /// </summary>
   public static readonly Velocity PlanckLengthPerDecillionYears = new("planck-length per decillion years"
                                                                     , "ℓₚ/decillion yr"
   ...
   public static readonly Velocity PlanckLengthPerTick =
      new("planck-length per tick", "ℓₚ/tick", SI.Velocities.MeterPerNanosecond, 1.616255E-35 / 100.0, system: "Theoretical Physics");
}