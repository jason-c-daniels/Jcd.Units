...
public class QuantityTests : TestBase
{
   ...
   public void op_Addition_When_Both_X_And_Y_Are_Same_Unit_Returns_The_Expected_Value(string unitName, double xValue, double yValue)
   {
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Addition_When_Both_X_And_Y_Are_Different_Unit_Returns_The_Expected_Value_In_The_Larger_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Addition_When_Either_X_Or_Y_Are_A_Double_Returns_The_Expected_Value_In_The_Source_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(nameof(UnitOfMeasure1Units.BaseUnit),     1,   0)]
   [InlineData(nameof(UnitOfMeasure1Units.DerivedUnit1), 2.1, 3.3)]
   public void op_Subtraction_When_Both_X_And_Y_Are_Same_Unit_Returns_The_Expected_Value(string unitName, double xValue, double yValue)
   {
      var expectedValue = xValue - yValue;
      var mockComparer = new Mock<IValueComparer<double>>();
      var unit = TestUnitProvider.GetUnit(unitName);
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Subtraction_When_Both_X_And_Y_Are_Different_Unit_Returns_The_Expected_Value_In_The_Larger_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Subtraction_When_Either_X_Or_Y_Are_Raw_Double_Returns_The_Expected_Value_In_The_Source_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(nameof(UnitOfMeasure1Units.BaseUnit),     1,   0)]
   [InlineData(nameof(UnitOfMeasure1Units.DerivedUnit1), 2.1, 3.3)]
   public void op_Multiply_When_Both_X_And_Y_Are_Same_Unit_Returns_The_Expected_Value(string unitName, double xValue, double yValue)
   {
      var expectedValue = xValue * yValue;
      var mockComparer = new Mock<IValueComparer<double>>();
      var unit = TestUnitProvider.GetUnit(unitName);
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Multiply_When_Both_X_And_Y_Are_Different_Unit_Returns_The_Expected_Value_In_The_Larger_Unit(double xValue, double yValue)
   {
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(1,   0)]
   [InlineData(2.1, 3.3)]
   public void op_Multiply_When_Either_X_Or_Y_Are_Raw_Double_Returns_The_Expected_Value_In_The_Source_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(nameof(UnitOfMeasure1Units.DerivedUnit1), 2.1, 3.3)]
   public void op_Division_When_Both_X_And_Y_Are_Same_Unit_Returns_The_Expected_Value(string unitName, double xValue, double yValue)
   {
      var expectedValue = xValue / yValue;
      var mockComparer = new Mock<IValueComparer<double>>();
      var unit = TestUnitProvider.GetUnit(unitName);
   ...
   [InlineData(3,   7)]
   [InlineData(2.1, 3.3)]
   public void op_Division_When_Both_X_And_Y_Are_Different_Unit_Returns_The_Expected_Value_In_The_Larger_Unit(double xValue, double yValue)
   {
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(3,   7)]
   [InlineData(2.1, 3.3)]
   public void op_Division_When_Either_X_Or_Y_Are_Raw_Double_Returns_The_Expected_Value_In_The_Source_Unit(double xValue, double yValue)
   {
      var mockComparer = new Mock<IValueComparer<double>>();
      var expectedUnit = TestUnitProvider.DerivedUnitX100;
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         true)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, false)]
   public void Equals_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, bool expectedValue)
   {
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         true)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, false)]
   public void GetHashCode_Returns_Expected_Value(string xUnit, double xValue, string yUnit, double yValue, bool expectEqualHashCodes)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         0)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, -1)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d, 1)]
   public void CompareTo_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, int expectedValue)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d)]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d)]
   public void CompareTo_When_Given_Null_Returns_NonZero_Result(string xUnit, double xValue, string yUnit, double yValue)
   {
      var xUnitOfMeasure = TestUnitProvider.GetUnit(xUnit);
      var yUnitOfMeasure = TestUnitProvider.GetUnit(yUnit);
      var x = xValue.As(xUnitOfMeasure);
   ...
   [Theory]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 1,                     false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 1.1,                   true)]  // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 0.9,                   false)] // greater than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  10,                    false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  9,                     false)] // greater than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  11,                    true)]  // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, true)]  // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d, false)] // greater than
   public void op_LessThan_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, bool expectedValue)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
      //UnitOfMeasure1.DefaultDoubleComparer           = SixDecimalPlacesComparer;
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  9,                     false)] // greater than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  11,                    true)]  // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         true)]  // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, true)]  // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d, false)] // greater than
   public void op_LessThanOrEqual_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, bool expectedValue)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
      //UnitOfMeasure1.DefaultDoubleComparer           = SixDecimalPlacesComparer;
   ...
   [Theory]
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 1,                     false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 1.1,                   false)] // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX100), 0.9,                   true)]  // greater than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  10,                    false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  9,                     true)]  // greater than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 10,      nameof(TestUnitProvider.DerivedUnitX10),  11,                    false)] // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d,         false)] // equal
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, false)] // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d, true)]  // greater than
   public void op_GreaterThan_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, bool expectedValue)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
      //UnitOfMeasure1.DefaultDoubleComparer           = SixDecimalPlacesComparer;
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d + 0.01d, false)] // less than
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10), 1d / 3d, nameof(TestUnitProvider.DerivedUnitX100), 1d / 3d / 10d - 0.01d, true)]  // greater than
   public void op_GreaterThanOrEqual_Returns_Expected_Result(string xUnit, double xValue, string yUnit, double yValue, bool expectedValue)
   {
      // NOTE: the comparer used compares up to 6 decimal places by first multiplying by 1,000,000 then converting to an Int64.
      // keep the InlineData in a range that's actually convertible.
      //UnitOfMeasure1.DefaultDoubleComparer           = SixDecimalPlacesComparer;
   ...
   [InlineData(nameof(TestUnitProvider.DerivedUnitX10),  10,  "",   "10.00 du x 10")]
   public void ToString_With_FormatString_Returns_Expected_Value(string unit, double value, string format, string expectedString)
   {
      var uom = TestUnitProvider.GetUnit(unit);
      var x = value.As(uom);
