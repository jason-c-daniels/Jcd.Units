...
Performs multiplication on a double and a [Quantity&lt;TUnit&gt;](Jcd.Units.Quantity_TUnit_.md 'Jcd.Units.Quantity<TUnit>').
...
<a name='Jcd.Units.Quantity_TUnit_.op_Multiply(Jcd.Units.Quantity_TUnit_,double).x'></a>
...
<a name='Jcd.Units.Quantity_TUnit_.op_Multiply(Jcd.Units.Quantity_TUnit_,double).y'></a>
