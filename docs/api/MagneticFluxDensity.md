...
| Constructors | |
| :--- | :--- |
| [MagneticFluxDensity(string, string, MagneticFluxDensity, double, double, IValueComparer&lt;double&gt;)](MagneticFluxDensity..ctor.ikGfCu2q+7MNeuYjZMKYfw.md 'Jcd.Units.UnitTypes.MagneticFluxDensity.MagneticFluxDensity(string, string, Jcd.Units.UnitTypes.MagneticFluxDensity, double, double, Jcd.Units.IValueComparer<double>)') | Constructs a unit measuring a specified [MagneticFluxDensity](MagneticFluxDensity.md 'Jcd.Units.UnitTypes.MagneticFluxDensity') using another [MagneticFluxDensity](MagneticFluxDensity.md 'Jcd.Units.UnitTypes.MagneticFluxDensity') as a reference. |
