...
## MathQ.Sin(Quantity<Angle>) Method

Returns the sine of the specified angle.

```csharp
public static double Sin(Jcd.Units.Quantity<Jcd.Units.UnitTypes.Angle> angle);
```
#### Parameters

<a name='Jcd.Units.MathQ.Sin(Jcd.Units.Quantity_Jcd.Units.UnitTypes.Angle_).angle'></a>
