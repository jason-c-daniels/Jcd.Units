...
Constructs a unit measuring a specified [Capacitance](Capacitance 'Jcd.Units.UnitTypes.Capacitance') using another [Capacitance](Capacitance 'Jcd.Units.UnitTypes.Capacitance') as a
reference.
