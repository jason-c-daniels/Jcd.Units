...
Implements [FromBaseUnitValue(double)](Jcd.Units.IUnitOfMeasure_TUnit_.FromBaseUnitValue(double).md 'Jcd.Units.IUnitOfMeasure<TUnit>.FromBaseUnitValue(double)')
