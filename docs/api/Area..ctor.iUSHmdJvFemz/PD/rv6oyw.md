...
The coefficient relative to the [baseUnit](Area..ctor.iUSHmdJvFemz/PD/rv6oyw.md#Jcd.Units.UnitTypes.Area.Area(string,string,Jcd.Units.UnitTypes.Area,double,double,Jcd.Units.IValueComparer_double_).baseUnit 'Jcd.Units.UnitTypes.Area.Area(string, string, Jcd.Units.UnitTypes.Area, double, double, Jcd.Units.IValueComparer<double>).baseUnit')
