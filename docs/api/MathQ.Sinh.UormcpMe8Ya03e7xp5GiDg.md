...
## MathQ.Sinh(Quantity<Angle>) Method

Returns the hyperbolic sine of the specified angle.

```csharp
public static double Sinh(Jcd.Units.Quantity<Jcd.Units.UnitTypes.Angle> angle);
```

#### Parameters

<a name='Jcd.Units.MathQ.Sinh(Jcd.Units.Quantity_Jcd.Units.UnitTypes.Angle_).angle'></a>
