...
Performs division on a double and a [Quantity&lt;TUnit&gt;](Quantity_TUnit_ 'Jcd.Units.Quantity<TUnit>').
...
When [y](Quantity_TUnit_.op_Division.0DEdJW268kz/Il5udWTnAw#Jcd.Units.Quantity_TUnit_.op_Division(Jcd.Units.Quantity_TUnit_,double).y 'Jcd.Units.Quantity<TUnit>.op_Division(Jcd.Units.Quantity<TUnit>, double).y') is zero.