...
| Constructors | |
| :--- | :--- |
| [CatalyticActivity(string, string, CatalyticActivity, double, double, IValueComparer&lt;double&gt;, string)](CatalyticActivity..ctor.Zf27xPKZWa93G02sxMBl4g.md 'Jcd.Units.UnitTypes.CatalyticActivity.CatalyticActivity(string, string, Jcd.Units.UnitTypes.CatalyticActivity, double, double, Jcd.Units.IValueComparer<double>, string)') | Constructs a unit measuring a specified [CatalyticActivity](CatalyticActivity.md 'Jcd.Units.UnitTypes.CatalyticActivity') using another<br/>[CatalyticActivity](CatalyticActivity.md 'Jcd.Units.UnitTypes.CatalyticActivity') as a reference. |
