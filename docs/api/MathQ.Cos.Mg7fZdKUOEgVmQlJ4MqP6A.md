...
## MathQ.Cos(Quantity<Angle>) Method

Returns the cosine of the specified angle.

```csharp
public static double Cos(Jcd.Units.Quantity<Jcd.Units.UnitTypes.Angle> angle);
```
#### Parameters

<a name='Jcd.Units.MathQ.Cos(Jcd.Units.Quantity_Jcd.Units.UnitTypes.Angle_).angle'></a>
