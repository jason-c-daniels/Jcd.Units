...
## MathQ.Tan(Quantity<Angle>) Method

Returns the tangent of the specified angle.

```csharp
public static double Tan(Jcd.Units.Quantity<Jcd.Units.UnitTypes.Angle> angle);
```
#### Parameters

<a name='Jcd.Units.MathQ.Tan(Jcd.Units.Quantity_Jcd.Units.UnitTypes.Angle_).angle'></a>
