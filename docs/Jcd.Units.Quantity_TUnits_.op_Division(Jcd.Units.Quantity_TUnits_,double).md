...
<a name='Jcd.Units.Quantity_TUnits_.op_Division(Jcd.Units.Quantity_TUnits_,double).x'></a>
...
<a name='Jcd.Units.Quantity_TUnits_.op_Division(Jcd.Units.Quantity_TUnits_,double).y'></a>
...
When [y](Jcd.Units.Quantity_TUnits_.op_Division(Jcd.Units.Quantity_TUnits_,double).md#Jcd.Units.Quantity_TUnits_.op_Division(Jcd.Units.Quantity_TUnits_,double).y 'Jcd.Units.Quantity<TUnits>.op_Division(Jcd.Units.Quantity<TUnits>, double).y') is zero.