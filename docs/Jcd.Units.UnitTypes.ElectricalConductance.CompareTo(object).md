...
## ElectricalConductance.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.ElectricalConductance.CompareTo(object).obj'></a>
...
When the passed in object is not a `ElectricalConductance`