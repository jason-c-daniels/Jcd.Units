...
## UnitOfMeasure<TUnit>.DefaultDoubleComparer Property

Sets the [IValueComparer&lt;T&gt;](Jcd.Units.IValueComparer_T_.md 'Jcd.Units.IValueComparer<T>') used by units of measure for this particular unit of  
measure type. (e.g. lengths.)

```csharp
public static Jcd.Units.IValueComparer<double>? DefaultDoubleComparer { get; set; }
```
