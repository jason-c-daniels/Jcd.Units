...
Performs subtraction on a double and a [Quantity&lt;TUnits&gt;](Jcd.Units.Quantity_TUnits_.md 'Jcd.Units.Quantity<TUnits>').
...
<a name='Jcd.Units.Quantity_TUnits_.op_Subtraction(double,Jcd.Units.Quantity_TUnits_).x'></a>

`x` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

The double operand

<a name='Jcd.Units.Quantity_TUnits_.op_Subtraction(double,Jcd.Units.Quantity_TUnits_).y'></a>
