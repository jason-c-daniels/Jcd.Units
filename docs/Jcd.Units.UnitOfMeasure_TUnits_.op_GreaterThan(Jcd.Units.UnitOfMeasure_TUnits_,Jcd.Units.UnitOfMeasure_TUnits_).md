...
Compares two [UnitOfMeasure&lt;TUnits&gt;](Jcd.Units.UnitOfMeasure_TUnits_.md 'Jcd.Units.UnitOfMeasure<TUnits>') instances to determine if the left one is greater than the right one.
...
<a name='Jcd.Units.UnitOfMeasure_TUnits_.op_GreaterThan(Jcd.Units.UnitOfMeasure_TUnits_,Jcd.Units.UnitOfMeasure_TUnits_).left'></a>
...
<a name='Jcd.Units.UnitOfMeasure_TUnits_.op_GreaterThan(Jcd.Units.UnitOfMeasure_TUnits_,Jcd.Units.UnitOfMeasure_TUnits_).right'></a>
