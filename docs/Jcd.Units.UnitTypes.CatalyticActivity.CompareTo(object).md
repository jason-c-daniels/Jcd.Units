...
## CatalyticActivity.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.CatalyticActivity.CompareTo(object).obj'></a>
...
When the passed in object is not a [CatalyticActivity](Jcd.Units.UnitTypes.CatalyticActivity.md 'Jcd.Units.UnitTypes.CatalyticActivity')