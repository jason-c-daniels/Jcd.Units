...
Compares two [Resistance](Jcd.Units.UnitTypes.Resistance.md 'Jcd.Units.UnitTypes.Resistance') instances to determine if the left one is greater than the right one.
