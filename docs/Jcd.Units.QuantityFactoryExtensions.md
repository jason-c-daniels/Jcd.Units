...
| [As&lt;TUnit,TNewUnit&gt;(this Quantity&lt;TUnit&gt;, TNewUnit)](Jcd.Units.QuantityFactoryExtensions.As_TUnit,TNewUnit_(thisJcd.Units.Quantity_TUnit_,TNewUnit).md 'Jcd.Units.QuantityFactoryExtensions.As<TUnit,TNewUnit>(this Jcd.Units.Quantity<TUnit>, TNewUnit)') | Converts an existing [Quantity&lt;TUnit&gt;](Jcd.Units.Quantity_TUnit_.md 'Jcd.Units.Quantity<TUnit>') into a new quantity replacing the existing units of measure with<br/>the the specified unit of measure, WITHOUT CONVERSION. |
