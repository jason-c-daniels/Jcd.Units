...
Compares two [Power](Jcd.Units.UnitTypes.Power.md 'Jcd.Units.UnitTypes.Power') instances to determine if the left one is less than the right one.
...
<a name='Jcd.Units.UnitTypes.Power.op_LessThan(Jcd.Units.UnitTypes.Power,Jcd.Units.UnitTypes.Power).left'></a>
...
<a name='Jcd.Units.UnitTypes.Power.op_LessThan(Jcd.Units.UnitTypes.Power,Jcd.Units.UnitTypes.Power).right'></a>
