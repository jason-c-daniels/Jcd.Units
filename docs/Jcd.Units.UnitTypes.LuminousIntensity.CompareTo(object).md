...
## LuminousIntensity.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.LuminousIntensity.CompareTo(object).obj'></a>
...
When the passed in object is not a [LuminousIntensity](Jcd.Units.UnitTypes.LuminousIntensity.md 'Jcd.Units.UnitTypes.LuminousIntensity')