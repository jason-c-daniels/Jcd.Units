...
## ElectricalCharge.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.ElectricalCharge.CompareTo(object).obj'></a>
...
When the passed in object is not a [ElectricalCharge](Jcd.Units.UnitTypes.ElectricalCharge.md 'Jcd.Units.UnitTypes.ElectricalCharge')