...
<a name='Jcd.Units.UnitTypes.Mass.CompareTo(object).obj'></a>
...
When the passed in object is not a [Mass](Jcd.Units.UnitTypes.Mass.md 'Jcd.Units.UnitTypes.Mass')