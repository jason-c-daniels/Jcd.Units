...
## Force(string, string, double, double) Constructor

A measurement of the rate of change of momentum.

```csharp
public Force(string Name, string Symbol, double Coefficient=1.0, double Offset=0.0);
```
#### Parameters

<a name='Jcd.Units.UnitTypes.Force.Force(string,string,double,double).Name'></a>

`Name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

The name of this unit of measure.

<a name='Jcd.Units.UnitTypes.Force.Force(string,string,double,double).Symbol'></a>
...
<a name='Jcd.Units.UnitTypes.Force.Force(string,string,double,double).Coefficient'></a>

`Coefficient` [System.Double](https://docs.microsoft.com/en-us/dotnet/api/System.Double 'System.Double')

The unit's coefficient relative to the ultimate base unit's representation.

<a name='Jcd.Units.UnitTypes.Force.Force(string,string,double,double).Offset'></a>
