...
## Energy.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.Energy.CompareTo(object).obj'></a>
...
When the passed in object is not a [Energy](Jcd.Units.UnitTypes.Energy.md 'Jcd.Units.UnitTypes.Energy')