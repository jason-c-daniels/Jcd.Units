...
## Pressure.CompareTo(object) Method
...
<a name='Jcd.Units.UnitTypes.Pressure.CompareTo(object).obj'></a>
...
When the passed in object is not a [Pressure](Jcd.Units.UnitTypes.Pressure.md 'Jcd.Units.UnitTypes.Pressure')