...
<a name='Jcd.Units.UnitTypes.Temperature.Temperature(string,string,double,double).Name'></a>

`Name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

The name of this unit

<a name='Jcd.Units.UnitTypes.Temperature.Temperature(string,string,double,double).Symbol'></a>
...
<a name='Jcd.Units.UnitTypes.Temperature.Temperature(string,string,double,double).Offset'></a>
