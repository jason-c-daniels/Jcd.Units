...
public static class EmbeddedResource
{
    public static string? ReadString(string resourceName)
        => Assembly.GetExecutingAssembly().ReadString(resourceName);
    ...
    public static byte[]? ReadBytes(string resourceName)
        => Assembly.GetExecutingAssembly().ReadBytes(resourceName);
    ...
    public static Stream? GetStream(string resourceName)
        => Assembly.GetExecutingAssembly().GetStream(resourceName);
    ...
    public static string? GetFullName(string resourceName) =>
        Assembly.GetExecutingAssembly().GetFullName(resourceName);
    
    public static string? GetFullName(this Assembly assembly, string resourceName) => 
        assembly.GetManifestResourceNames().FirstOrDefault(str => str.EndsWith(resourceName));
}
