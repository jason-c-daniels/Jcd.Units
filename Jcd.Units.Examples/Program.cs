...
var sdurr = durr.To(Physics.Durations.PlanckTime).ToString("e3");
...
Console.WriteLine($"{OneThousandKelvinT:n3} == {OneThousandKelvinAndOneMillikelvinT:n3} : {OneThousandKelvinT == OneThousandKelvinAndOneMillikelvinT}");

Console.WriteLine($"{OneKilokelvinT:n3} == {OneThousandKelvinAndOneMillikelvinT:n3} : {OneKilokelvinT == OneThousandKelvinAndOneMillikelvinT}");
...
Console.WriteLine("Compare temp quantities after Quantity<Temperature>.DefaultDoubleComparer = new Int64ConversionComparer(100); (equal to 2 decimal places once in a common unit representation)"
                 );
